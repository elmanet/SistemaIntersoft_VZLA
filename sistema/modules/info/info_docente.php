...
$query_reporte = sprintf("SELECT * FROM jos_docente" , GetSQLValueString($colname_reporte, "text"));
...
<td valign="top" align="center" class="texto_mediano_gris" ><h1>INFORMACION GENERAL DE DOCENTES</h1></td></tr>
<tr><td align="center"><h2> Total de Docentes: <?php echo $totalRows_reporte;?></h2></span>
<h4 align="center"><a href="../reportes/re_docente_general.php" target="_blank">Ver listado General de Docentes</a></h4>
</td></tr>
<td>
