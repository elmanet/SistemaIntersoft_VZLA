...
<table width="760" border="0" cellspacing="0" cellpadding="0">
 ...
 <td width="25" class="textogrande_eloy"><div align="center"><span class="texto_mediano_gris"><a href="eliminar_inasistencia_alumno_coordinacion.php?id=<?php echo $row_reporte['id']; ?>&curso_id=<?php echo $_GET['curso_id']; ?>"><img src="../../images/png/eliminar.PNG" border="0" align="absmiddle"></span></div></td>
