...
$cur=1;
 ...
 $updateGoTo = "asignar_alumno_03.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_sistemacol, $sistemacol);
$query_reporte = sprintf("SELECT alumno_id, nombre, apellido  FROM jos_alumno_info WHERE cedula= %s" , GetSQLValueString($colname_reporte, "text"));
...
mysql_select_db($database_sistemacol, $sistemacol);
$query_curso = sprintf("SELECT a.alumno_id, a.cedula, b.alumno_id FROM jos_alumno_info a, jos_alumno_curso b WHERE a.alumno_id=b.alumno_id AND cedula= %s" , GetSQLValueString($colname_curso, "text"));
...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  <!--DWLayoutTable-->
  <tr>
    <td valign="top"><h2>Asignar Seccion a Estudiante</h2></td></tr>
	<tr>	
	<td>
	...
	<input type="text" name="no_lista" value="" size="3" maxlength="2"/>
	...
	<input type="hidden" name="alumno_id" value="<?php echo $row_reporte['alumno_id']; ?>" />
	...
	<?php if ($totalRows_curso>0){?>
	<span class="texto_mediano_gris"><b> <?php echo $row_reporte['nombre']; ?>, YA HA SIDO ASIGNADO A UNA SECCION...</b></span>
	<br><br>	
