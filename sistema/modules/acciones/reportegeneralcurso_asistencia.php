...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign="top">
        <h1><img src="../../images/pngnew/busqueda-de-los-usuarios-del-hombre-icono-6234-48.png" border="0" align="absmiddle">&nbsp;&nbsp;Inasistencias Cargadas al Sistema!</h1>
 ...
 <td width="25" class="textogrande_eloy"><div align="center"><span class="texto_mediano_gris"><a href="eliminar_inasistencia_alumno.php?id=<?php echo $row_reporte['id']; ?>&asignatura_id=<?php echo $_GET['asignatura_id']; ?>"><img src="../../images/png/eliminar.PNG" border="0" align="absmiddle"></span></div></td>
...
<p align="center">"No exiten Datos para Mostrar!"</p><b>Cierra esta Ventana</b><br /><br />
</div>
</div>
	</td></tr>
