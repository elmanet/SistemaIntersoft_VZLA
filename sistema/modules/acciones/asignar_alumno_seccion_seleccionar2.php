...
$query_seccion = sprintf("SELECT * FROM jos_anio_nombre ORDER BY id ASC");
...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign="top">
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Estudiantes Asignados con Exito!</h2>
	<h3>Seleccione la Seccion a Asignar... </h3>
	<form action="asignar_alumno_seccion.php" method="POST" >
	...
	<input type="submit" name="buttom" value="Consultar >" />
	</form>
