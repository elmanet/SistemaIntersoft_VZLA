...
<tr><td>
<form action="datos_alumno2.php" name="form" id="form" method="POST" enctype="multipart/form-data" target="_blank">
<div id="recuadro_cedula"><br />
<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Verificar Datos Matr&iacute;cula!</h2>
...
<input type="hidden" name="tipor" value="1" />
...
<p align="center">"Para verificar los Datos de los Estudiantes" <br /></p>
</div>
</div>
	</td></tr>
