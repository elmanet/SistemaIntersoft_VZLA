...
<div id="div_acceso">
 ...
 <form action="retirar_estudiante2.php" id="captchaform" onsubmit="return checkSubmit();" method="GET" enctype="multipart/form-data" target="_self" class="cmxform" >
 		<table>
 		<tr>
		<td colspan="2">
		...
		<tr>
			...
			<input class="text_input_peq" style="width:180px;" type="text" id="cedula" name="cedula" onKeyUp="this.value=this.value.toUpperCase()"/>&nbsp;&nbsp;<input type="submit" name="submit" id="btsubmit" value="Verificar Cuenta" class="texto_grande_gris"  /><div style="color:red; font-weight: bold; font-size:25px;" id="msgUsuario"></div></td>
