...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  <!--DWLayoutTable-->
  <tr>
    <td valign="top"><h3>Seleccione la Secci&oacute;n a Trabajar... </h3>
	<form action="asistencia_alumno.php" method="GET" target="_blank">
	<select name="curso_id" class="texto_mediano_gris" id="curso_id">
	  ...
	  $row_seccion = mysql_fetch_assoc($seccion);
	   ...
	   ?>
         ...
         <br />
         <br />
         <span class="texto_grande_gris"><b>Fecha de la inasistencia:<br /> </b></span> <span class="texto_mediano_gris"> D&iacute;a <input type="text" size="3" maxlength="2" class="texto_pequeno_gris" name="dia" value="" /> Mes <input type="text" size="3" class="texto_pequeno_gris" maxlength="2" name="mes" value="" /> A&ntilde;o <input type="text" size="5" class="texto_pequeno_gris" maxlength="4" name="ano" value="<?php echo date(Y);?>" /></span>
	<input type="submit" name="buttom" value="Seleccionar >" />
	</form>
