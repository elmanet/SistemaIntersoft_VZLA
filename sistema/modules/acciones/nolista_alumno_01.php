...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  <!--DWLayoutTable-->
  <tr>
  <h2>CONFIGURAR NO. DE LISTA DE ESTUDIANTES</h2>
    <td valign="top"><h3>Seleccione Secci&oacute;n a Configurar... </h3>
	<form action="nolista_alumno_02.php" method="POST" >
	<select name="orden" class="texto_mediano_gris">
	<option value="1">Orden Alfabetico</option>
	<option value="0">Orden de C&eacute;dula</option>
	</select>
