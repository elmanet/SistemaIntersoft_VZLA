...
<title>AJAX y tabs, ejemplo básico de navegación con pestañas</title>
<link rel="stylesheet" type="text/css" href="tabs_o_pestanas_con_javascript_no_intrusivo.css">
<script type="text/javascript" src="tabs_o_pestanas_con_javascript_no_intrusivo.js"></script>
</head>

<body>	
			<div id="demo">
				<div class="tabOn" id="tab1">Tab 1</div>
				<div class="tabOff" id="tab2">Tab 2</div>
				<div class="tabOff" id="tab3">Tab 3</div>
