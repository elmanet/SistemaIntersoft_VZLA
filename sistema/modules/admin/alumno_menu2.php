...
<?php if (($row_usuario['gid']>22) and ($row_usuario['gid']<51)) { // INICIO DE LA CONSULTA 
?>
<table width="500" border="0">
      ...
      <tr><td height="20" valign="top"><a href="../../com_inscripcion/planilla_inscripcion_verifica.php" >Agregar o Modificar Estudiante</a></td></tr>
