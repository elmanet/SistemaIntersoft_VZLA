...
mysql_select_db($database_sistemacol, $sistemacol);
$query_docente = sprintf("SELECT f.descripcion, g.nombre, e.id as cursoid FROM jos_users a, jos_docente b, jos_curso e, jos_seccion f, jos_anio_nombre g WHERE  a.id=b.joomla_id AND b.id=e.docente_id AND e.seccion_id=f.id AND e.anio_id=g.id AND a.username = %s", GetSQLValueString($colname_docente, "text"));
...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Imprimir Boletines!</h2>
	<h3>Selecciona el a&ntilde;o... </h3>
	<form action="../docente/imprimir_boletin2.php" method="GET" name="f1" target="_blank">
