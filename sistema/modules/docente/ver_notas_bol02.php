...
$lapso_planilla = "-1";
if (isset($_GET['lapso'])) {
  $lapso_planilla = $_GET['lapso'];
}
mysql_select_db($database_sistemacol, $sistemacol);
$query_planilla = sprintf("SELECT * FROM jos_formato_evaluacion_bol02 a, jos_alumno_info b, jos_formato_evaluacion_planilla c WHERE a.alumno_id=b.alumno_id AND a.confiplanilla_id=c.id AND a.asignatura_id = %s AND c.lapso = %s ORDER BY b.apellido ASC", GetSQLValueString($colname_planilla, "text"), GetSQLValueString($lapso_planilla, "text"));
...
$lapso_confiplanilla = "-1";
if (isset($_GET['lapso'])) {
  $lapso_confiplanilla = $_POST['lapso'];
}
mysql_select_db($database_sistemacol, $sistemacol);
$query_confiplanilla = sprintf("SELECT * FROM jos_formato_evaluacion_planilla WHERE asignatura_id = %s AND lapso=%s ORDER BY id DESC", GetSQLValueString($colname_confiplanilla, "int"), GetSQLValueString($lapso_confiplanilla, "int"));
...
<table id="ancho_planilla_4deagosto" style="font-size:9px;" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#fff" bordercolor="#000000" bordercolordark="#000000" class="borde">
 ...
 <tr bgcolor="#00FF99" class="textogrande_eloy" >
		...
		<td style="border-left:1px solid"><div align="center"><span>&nbsp;<?php echo $lista; $lista ++; ?>&nbsp;</span></div></td>
                ...
                <td style="border-left:1px solid; background-color:#FFFCCC;"><div align="center"><span><b></b></span></div></td>
