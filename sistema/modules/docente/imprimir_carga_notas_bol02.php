...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Imprimir Calificaciones Cargadas!</h2>
	<h3>Selecciona la Asignatura para visualizar las calificaciones... </h3>
	<form action="../docente/ver_notas_<?php echo $row_confi['codfor']; ?>.php" method="GET" name="f1" target="_blank">
