...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Calificaciones Cargadas con Exito!</h2>
	<h3>Selecciona la Asignatura para visualizar las calificaciones... </h3>
	<form action="../docente/ver_notas_<?php echo $row_confi['codfor']; ?>.php" method="GET" name="f1">
	...
	<tr><td>
		<h4>Puedes escoger otra asignatura si ya cargaste las calificaciones! </h4>
		<h4 style="color:red">Para Subir Calificaciones de otra asignatura cierra esta ventana y vuelve a tu sesi&oacute;n personal </h4>
	</td></tr>
	</form>
<tr><td>
&nbsp;&nbsp;
