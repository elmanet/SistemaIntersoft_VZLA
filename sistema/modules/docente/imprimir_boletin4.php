...
FROM jos_formato_evaluacion_bol01 a, jos_alumno_info b, jos_curso d, jos_anio_nombre e, jos_seccion f, jos_alumno_curso g, jos_formato_evaluacion_planilla h

WHERE a.alumno_id=b.alumno_id AND b.alumno_id=g.alumno_id AND g.curso_id=d.id AND d.seccion_id=f.id AND d.anio_id=e.id AND a.confiplanilla_id=h.id AND a.alumno_id = %s AND a.lapso = %s", GetSQLValueString($colname_alumno, "int"), GetSQLValueString($lapso_alumno, "int"));
...
if (isset($_GET['alumno_id'])) {
  $colname_boletin_des = $_GET['alumno_id'];
}
$lap_boletin_des = "-1";
if (isset($_GET['lapso'])) {
...
mysql_select_db($database_sistemacol, $sistemacol);
$query_boletin_des = sprintf("SELECT * FROM jos_formato_nota_descriptiva_bol01 WHERE alumno_id = %s AND lapso=%s", GetSQLValueString($colname_boletin_des, "int"),GetSQLValueString($lap_boletin_des, "int"));
...
if (isset($_GET['alumno_id'])) {
  $colname_profe_guia = $_GET['alumno_id'];
}
mysql_select_db($database_sistemacol, $sistemacol);
$query_profe_guia = sprintf("SELECT * FROM jos_alumno_curso a, jos_curso b, jos_docente c WHERE a.curso_id=b.id AND b.docente_id=c.id AND alumno_id = %s", GetSQLValueString($colname_profe_guia, "int"));
...
mysql_select_db($database_sistemacol, $sistemacol);
$query_asignatura = sprintf("SELECT * FROM jos_formato_evaluacion_bol01 a, jos_asignatura b, jos_asignatura_nombre c WHERE a.asignatura_id=b.id AND b.asignatura_nombre_id=c.id AND b.tipo_asignatura='' AND alumno_id = %s AND lapso = %s ORDER BY b.orden_asignatura ASC" , GetSQLValueString($colname_asignatura, "int"), GetSQLValueString($lapso_asignatura, "int"));
...
if (isset($_GET['alumno_id'])) {
  $colname_asignatura1 = $_GET['alumno_id'];
}

mysql_select_db($database_sistemacol, $sistemacol);
$query_asignatura1 = sprintf("SELECT * FROM jos_formato_evaluacion_bol01 a, jos_asignatura b, jos_asignatura_nombre c WHERE a.asignatura_id=b.id AND b.asignatura_nombre_id=c.id AND b.tipo_asignatura='' AND alumno_id = %s AND lapso = 1 ORDER BY b.orden_asignatura ASC" , GetSQLValueString($colname_asignatura1, "int"));
...
if (isset($_GET['alumno_id'])) {
  $colname_asignatura2 = $_GET['alumno_id'];
}

mysql_select_db($database_sistemacol, $sistemacol);
$query_asignatura2 = sprintf("SELECT * FROM jos_formato_evaluacion_bol01 a, jos_asignatura b, jos_asignatura_nombre c WHERE a.asignatura_id=b.id AND b.asignatura_nombre_id=c.id AND b.tipo_asignatura='' AND alumno_id = %s AND lapso = 2 ORDER BY b.orden_asignatura ASC" , GetSQLValueString($colname_asignatura2, "int"));
...
if (isset($_GET['alumno_id'])) {
  $colname_asignatura3 = $_GET['alumno_id'];
}

mysql_select_db($database_sistemacol, $sistemacol);
$query_asignatura3 = sprintf("SELECT * FROM jos_formato_evaluacion_bol01 a, jos_asignatura b, jos_asignatura_nombre c WHERE a.asignatura_id=b.id AND b.asignatura_nombre_id=c.id AND b.tipo_asignatura='' AND alumno_id = %s AND lapso = 3 ORDER BY b.orden_asignatura ASC" , GetSQLValueString($colname_asignatura3, "int"));
...
$colname_mate141 = "-1";
if (isset($_GET['alumno_id'])) {
  $colname_mate141 = $_GET['alumno_id'];
}
mysql_select_db($database_sistemacol, $sistemacol);
$query_mate141 = sprintf("SELECT ROUND(AVG(a.def),0) as def FROM jos_formato_evaluacion_bol01 a, jos_asignatura b, jos_asignatura_nombre c WHERE a.asignatura_id=b.id AND b.asignatura_nombre_id=c.id AND b.tipo_asignatura='educacion_trabajo' AND alumno_id = %s AND lapso = 1 GROUP BY a.alumno_id" , GetSQLValueString($colname_mate141, "int"));
...
$colname_mate142 = "-1";
if (isset($_GET['alumno_id'])) {
  $colname_mate142 = $_GET['alumno_id'];
}
mysql_select_db($database_sistemacol, $sistemacol);
$query_mate142 = sprintf("SELECT ROUND(AVG(a.def),0) as def FROM jos_formato_evaluacion_bol01 a, jos_asignatura b, jos_asignatura_nombre c WHERE a.asignatura_id=b.id AND b.asignatura_nombre_id=c.id AND b.tipo_asignatura='educacion_trabajo' AND alumno_id = %s AND lapso = 2 GROUP BY a.alumno_id" , GetSQLValueString($colname_mate142, "int"));
...
$colname_mate143 = "-1";
if (isset($_GET['alumno_id'])) {
  $colname_mate143 = $_GET['alumno_id'];
}
mysql_select_db($database_sistemacol, $sistemacol);
$query_mate143 = sprintf("SELECT ROUND(AVG(a.def),0) as def FROM jos_formato_evaluacion_bol01 a, jos_asignatura b, jos_asignatura_nombre c WHERE a.asignatura_id=b.id AND b.asignatura_nombre_id=c.id AND b.tipo_asignatura='educacion_trabajo' AND alumno_id = %s AND lapso = 3 GROUP BY a.alumno_id" , GetSQLValueString($colname_mate143, "int"));
    ...
    <td colspan="3" align="center"><table border="0" >
      <tr>
        <td width="500" align="left" valign="top"><table border="1" cellpadding="0" cellspacing="0" style="font-family:verdana; font-size: 10px; color:#424242; ">
            <tr>
              <td width="220" align="center"><span style="font-size:14px; font-family: verdana; color: #424242"><strong>ASIGNATURAS</strong></span></td>
...
*/?>
            ...
            <?php do { ?>
              <tr>
                <td width="220"  height="20" align="center"><span><strong><?php echo $row_asignatura1['nombre']; ?></strong></span></td>
...
<?php } ?>
        ...
        <td width="350" valign="top"><table border="1" cellpadding="0" cellspacing="0" style="width:10cm; margin-left:0">
          <tr>
          ...
          <tr>
            <td class="texto_mediano_gris"><br>
              <table border="0" align="center" cellpadding="0" cellspacing="0" style="width:13cm">
              <tr>
