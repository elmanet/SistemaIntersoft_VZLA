...
$po1=($row_planilla['p1f1']*$row_confiplanilla['p1'])/100;
$po2=($row_planilla['p2f1']*$row_confiplanilla['p2'])/100;
$po3=($row_planilla['p3f1']*$row_confiplanilla['p3'])/100;
$po4=($row_planilla['p4f1']*$row_confiplanilla['p4'])/100;
$po5=($row_planilla['p5f1']*$row_confiplanilla['p5'])/100;
$po6=($row_planilla['p6f1']*$row_confiplanilla['p6'])/100;
?>
            ...
            <td colspan="2" align="center" valign="top" class="titulosgrandes_eloy"><table border="0">
              <tr>
                <td width="2507" height="40" align="center"><table width="1200" border="1" align="left" cellpadding="0" cellspacing="0" bordercolor="#000000" bordercolordark="#000000">
                  <tr>
                      <td colspan="28" align="left" class="texto_pequeno_gris"><table width="1200" border="0" align="center">
                        <tr>
                  ...
                  <tr>
                    ...
                    <td colspan="17" align="center" class="texto_pequeno_gris"><strong>CALIFICACIONES DE EVALUACIONES PARCIALES</strong></td>
            <?php /*
                    ...
                    <td width="40" rowspan="6" align="center" class="texto_pequeno_gris"><strong>Cal.Pro.</strong></td>
*/?>
                  ...
                  <tr>
                    ...
                    <td colspan="2" align="center" class="texto_pequeno_gris"><strong>Ser y Convivir</strong></td>
                    </tr>
                  <tr>
                    <td colspan="17" align="center" class="texto_pequeno_gris"><strong>PORCENTAJES</strong></td>
                    </tr>
                  <tr>
                    ...
                    <td colspan="2" align="center" class="texto_pequeno_gris"><strong><?php echo $row_confiplanilla['p6']; ?>%</strong></td>
                  <?php //  <td colspan="3" align="center" class="texto_pequeno_gris"><strong>30%</strong></td> ?>
                    </tr>
                  <tr>
             ...
             */?>
                    ...
                    <tr >
                        ...
                        <td height="20" align="center" style="font-family: verdana; font-size: 8px;">&nbsp;<?php echo $row_planilla['indicador_nacionalidad']; ?>-<?php echo $row_planilla['cedula']; ?>&nbsp;</td>
                        <td height="20" align="left" style="font-family: verdana; font-size: 8px;">&nbsp;<?php echo $row_planilla['apellido']; ?>, <?php echo $row_planilla['nombre']; ?></td>
                        <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['p1f1']==(int)0.00 && $row_planilla['p1f1']==!null){ echo 'NP';} if($row_planilla['p1f1']>0){ echo round($row_planilla['p1f1'],0);} if($row_planilla['p1f1']==null){ echo '';} ?> </td>
                        <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['p1f2']==(int)0.00 && $row_planilla['p1f2']==!null){ echo 'NP';} if($row_planilla['p1f2']>0){ echo round($row_planilla['p1f2'],0);} if($row_planilla['p1f2']==null){ echo '';} ?></td>
                        
                        <?php if($row_planilla['p1f2']==null){?>
                        <td align="center" class="texto_pequeno_gris"><b><?php $po1=($row_planilla['p1f1']*$row_confiplanilla['p1'])/100; if($po1==0){ echo '';} else { echo $po1;} ?></b></td>
                        <?php } else { ?>
                        <td align="center" class="texto_pequeno_gris"><b><?php $po1=($row_planilla['p1f2']*$row_confiplanilla['p1'])/100; if($po1==0){ echo '';} else { echo $po1;} ?></b></td>
                        <?php } ?>
                        <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['p2f1']==(int)0.00 && $row_planilla['p2f1']==!null){ echo 'NP';} if($row_planilla['p2f1']>0){ echo round($row_planilla['p2f1'],0);} if($row_planilla['p2f1']==null){ echo '';} ?></td>
                        <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['p2f2']==(int)0.00 && $row_planilla['p2f2']==!null){ echo 'NP';} if($row_planilla['p2f2']>0){ echo round($row_planilla['p2f2'],0);} if($row_planilla['p2f2']==null){ echo '';} ?></td>
                       
                        <?php if($row_planilla['p2f2']==null){?>
                        <td align="center" class="texto_pequeno_gris"><b><?php $po2=($row_planilla['p2f1']*$row_confiplanilla['p2'])/100; if($po2==0){ echo '';} else { echo $po2;} ?></b></td>
                        <?php } else { ?>
                        <td align="center" class="texto_pequeno_gris"><b><?php $po2=($row_planilla['p2f2']*$row_confiplanilla['p2'])/100; if($po2==0){ echo '';} else { echo $po2;} ?></b></td>
                        <?php } ?>

                         <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['p3f1']==(int)0.00 && $row_planilla['p3f1']==!null){ echo 'NP';} if($row_planilla['p3f1']>0){ echo round($row_planilla['p3f1'],0);} if($row_planilla['p3f1']==null){ echo '';} ?></td>
                        <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['p3f2']==(int)0.00 && $row_planilla['p3f2']==!null){ echo 'NP';} if($row_planilla['p3f2']>0){ echo round($row_planilla['p3f2'],0);} if($row_planilla['p3f2']==null){ echo '';} ?></td>
                        <?php if($row_planilla['p3f2']==null){?>
                        <td align="center" class="texto_pequeno_gris"><b><?php $po3=($row_planilla['p3f1']*$row_confiplanilla['p3'])/100; if($po3==0){ echo '';} else { echo $po3;} ?></b></td>
                        <?php } else { ?>
                        <td align="center" class="texto_pequeno_gris"><b><?php $po3=($row_planilla['p3f2']*$row_confiplanilla['p3'])/100; if($po3==0){ echo '';} else { echo $po3;} ?></b></td>
                        <?php } ?>


                         <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['p4f1']==(int)0.00 && $row_planilla['p4f1']==!null){ echo 'NP';} if($row_planilla['p4f1']>0){ echo round($row_planilla['p4f1'],0);} if($row_planilla['p4f1']==null){ echo '';} ?></td>
                        <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['p4f2']==(int)0.00 && $row_planilla['p4f2']==!null){ echo 'NP';} if($row_planilla['p4f2']>0){ echo round($row_planilla['p4f2'],0);} if($row_planilla['p4f2']==null){ echo '';} ?></td>
                        <?php if($row_planilla['p4f2']==null){?>
                        <td align="center" class="texto_pequeno_gris"><b><?php $po4=($row_planilla['p4f1']*$row_confiplanilla['p4'])/100; if($po4==0){ echo '';} else { echo $po4;} ?></b></td>
                        <?php } else { ?>
                        <td align="center" class="texto_pequeno_gris"><b><?php $po4=($row_planilla['p4f2']*$row_confiplanilla['p4'])/100; if($po4==0){ echo '';} else { echo $po4;} ?></b></td>
                        <?php } ?>


                         <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['p5f1']==(int)0.00 && $row_planilla['p5f1']==!null){ echo 'NP';} if($row_planilla['p5f1']>0){ echo round($row_planilla['p5f1'],0);} if($row_planilla['p5f1']==null){ echo '';} ?></td>
                        <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['p5f2']==(int)0.00 && $row_planilla['p5f2']==!null){ echo 'NP';} if($row_planilla['p5f2']>0){ echo round($row_planilla['p5f2'],0);} if($row_planilla['p5f2']==null){ echo '';} ?></td>
                        <?php if($row_planilla['p5f2']==null){?>
                        <td align="center" class="texto_pequeno_gris"><b><?php $po5=($row_planilla['p5f1']*$row_confiplanilla['p5'])/100; if($po5==0){ echo '';} else { echo $po5;} ?></b></td>
                        <?php } else { ?>
                        <td align="center" class="texto_pequeno_gris"><b><?php $po5=($row_planilla['p5f2']*$row_confiplanilla['p5'])/100; if($po5==0){ echo '';} else { echo $po5;} ?></b></td>
                        <?php } ?>


                         <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['p6f1']==(int)0.00 && $row_planilla['p6f1']==!null){ echo 'NP';} if($row_planilla['p6f1']>0){ echo round($row_planilla['p6f1'],0);} if($row_planilla['p6f1']==null){ echo '';} ?></td>
                      <td align="center" class="texto_pequeno_gris"><b><?php $po6=($row_planilla['p6f1']*$row_confiplanilla['p6'])/100; if($po6==0){ echo '';} else { echo $po6;} ?></b></td>
<?php /*  
                        <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['sumapon']==(int)0.00 && $row_planilla['sumapon']!==null){ echo '';} else { echo round($row_planilla['sumapon'],0);} ?></td>
                     ...
                     <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['flf1']==(int)0.00 && $row_planilla['flf1']==null){ echo '';} else { echo round($row_planilla['flf1'],0);} ?></td>
                        <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['flf2']==(int)0.00 && $row_planilla['flf2']==null){ echo '';} else { echo round($row_planilla['flf2'],0);} ?></td>
                    ...
                    <td width="337" align="center" valign="middle" class="texto_mediano_gris">
                     ...
                     <table border="1" cellpadding="0" cellspacing="0" bordercolordark="#000000" bordercolorlight="#000000" class="ocultar">
                      ...
                      <tr>
                        ...
                        <td width="30" height="15" align="center" valign="middle" class="texto_pequeno_gris">&nbsp;&nbsp;<?php if($totalRows_planilla > 22 and $pageNum_planilla==0){ echo 22;} if($totalRows_planilla > 22 and $pageNum_planilla==1){$newtotal=$totalRows_planilla-22; echo $newtotal;} if($totalRows_planilla < 22){echo $totalRows_planilla;} ?>&nbsp;</td>
                      </tr>
                      <tr>
