...
$po4=$_POST['p4'];
$po5=$_POST['p5'];
$totalporcentaje=($po1+$po2+$po3+$po4+$po5);
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
   ...
   $insertSQL = sprintf("INSERT INTO jos_formato_evaluacion_planilla (id, asignatura_id, lapso, nombre_proyecto, cant_pruebas, isc1, isc2, isc3, isc4, p1, p2, p3, p4, p5, info1, tipo_eva1, fecha1, info2, tipo_eva2, fecha2, info3, tipo_eva3, fecha3, info4, tipo_eva4, fecha4, info5, tipo_eva5, fecha5) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s )",
...
<?php if (($row_confi['codfor']=="bol01") or ($row_confi['codfor']=="nor01")){?>
...
<tr><td>
<form action="carga_notas_<?php echo $row_confi['codfor'];?>.php" method="POST" name="form_enviar">
...
<?php if (($row_confi['codfor']=="bol02") or ($row_confi['nor01'])){?>
...
<?php if (($row_confi['codfor']=="bol02") or ($row_confi['codfor']=="nor01")){?>
	<input name="isc4" type="hidden" id="isc4" value=""/>
<?php } ?>
