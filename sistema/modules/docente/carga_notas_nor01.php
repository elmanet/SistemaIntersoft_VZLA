...
mysql_select_db($database_sistemacol, $sistemacol);
$query_planilla = sprintf("SELECT * FROM jos_formato_evaluacion_nor01 a, jos_alumno_info b WHERE a.lapso=$lapso_curso AND a.alumno_id=b.alumno_id AND a.asignatura_id = %s ORDER BY b.cedula ASC", GetSQLValueString($colname_planilla, "int"));
...
// CALCULAR
	...
	// FIN CALCULO
     ...
     $insertSQL = sprintf("INSERT INTO jos_formato_evaluacion_nor01 (id, alumno_id, asignatura_id, confiplanilla_id, lapso, p1f1, p1f2, p2f1, p2f2, p3f1, p3f2, p4f1, p4f2, p5f1, p5f2, sumanotas, ind1, ind2, ind3, indtotal, sumapon, seten, flf1, flf2, treinta, calpro,  def, ajuste) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                            ...
                            GetSQLValueString($_POST['ind1'.$i], "int"),
                            GetSQLValueString($_POST['ind2'.$i], "int"),
                            GetSQLValueString($_POST['ind3'.$i], "int"),
                            GetSQLValueString($_POST['indtotal'.$i], "int"),

                            GetSQLValueString($sumapon, "double"),
                            GetSQLValueString($seten, "double"),

                            GetSQLValueString($flf1, "double"),
                            GetSQLValueString($flf2, "double"),
  ...
  $insertGoTo = "fin_carga_notas_nor01.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
// CALCULAR
	...
	// FIN CALCULO
     ...
     $updateSQL = sprintf("update jos_formato_evaluacion_nor01 SET alumno_id=%s, asignatura_id=%s, confiplanilla_id=%s, lapso=%s, p1f1=%s, p1f2=%s, p2f1=%s, p2f2=%s, p3f1=%s, p3f2=%s, p4f1=%s, p4f2=%s, p5f1=%s, p5f2=%s, sumanotas=%s, ind1=%s, ind2=%s, ind3=%s, indtotal=%s, sumapon=%s, seten=%s, flf1=%s, flf2=%s, treinta=%s, calpro=%s, def=%s, ajuste=%s WHERE id=%s",
                            GetSQLValueString($_POST['alumno_id'.$i], "int"),
                            GetSQLValueString($_POST['asignatura_id'.$i], "int"),
                            GetSQLValueString($_POST['confiplanilla_id'.$i], "int"),
                            GetSQLValueString($_POST['lapso'.$i], "int"),
  ...
  $updateGoTo = "fin_carga_notas_nor01.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<?php }
?>
                <td width="30"><div align="center"><span>RP1</span></div></td>
                <td width="30"><div align="center"><span>RP2</span></div></td>
                <td width="30"><div align="center"><span>RP3</span></div></td>
                <td width="30"><div align="center"><span>RP</span></div></td>
...
<?php // readonly="readonly" para bloquear las casillas 
?>
...
?>
                <td style="border-left:1px solid"><div align="center"><span><select name="<?php echo 'ind1'.$i;?>" id="<? echo 'ind1'.$i;?>"  class="texto_mediano_gris"><option value="<?php echo $row_planilla['ind1']; ?>"><?php if($row_planilla['ind1']=='2') { echo 'A';} if($row_planilla['ind1']=='1') { echo 'B';} if($row_planilla['ind1']=='0') { echo 'C';}  ?></option><option value="">...</option><option value="2">A</option><option value="1">B</option><option value="0">C</option></select></span></div></td>

                <td style="border-left:1px solid"><div align="center"><span><select name="<?php echo 'ind2'.$i;?>" id="<? echo 'ind2'.$i;?>"  class="texto_mediano_gris"><option value="<?php echo $row_planilla['ind2']; ?>"><?php if($row_planilla['ind2']=='2') { echo 'A';} if($row_planilla['ind2']=='1') { echo 'B';} if($row_planilla['ind2']=='0') { echo 'C';}  ?></option><option value="">...</option><option value="2">A</option><option value="1">B</option><option value="0">C</option></select></span></div></td>

                <td style="border-left:1px solid"><div align="center"><span><select name="<?php echo 'ind3'.$i;?>" id="<? echo 'ind3'.$i;?>"  class="texto_mediano_gris"><option value="<?php echo $row_planilla['ind3']; ?>"><?php if($row_planilla['ind3']=='2') { echo 'A';} if($row_planilla['ind3']=='1') { echo 'B';} if($row_planilla['ind3']=='0') { echo 'C';}  ?></option><option value="">...</option><option value="2">A</option><option value="1">B</option><option value="0">C</option></select></span></div></td>

                <td style="border-left:1px solid"><div align="center"><span><select name="<?php echo 'indtotal'.$i;?>" id="<? echo 'indtotal'.$i;?>"  class="texto_mediano_gris"><option value="<?php echo $row_planilla['indtotal']; ?>"><?php if($row_planilla['indtotal']=='2') { echo 'A';} if($row_planilla['indtotal']=='1') { echo 'B';} if($row_planilla['indtotal']=='0') { echo 'C';}  ?></option><option value="">...</option><option value="2">A</option><option value="1">B</option><option value="0">C</option></select></span></div></td>
...
<?php } else { ?>
<td style="border-left:1px solid; background-color:#fffccc;"><div align="center"><span><input name="<?php echo 'flf2'.$i;?>" type="text" id="<? echo 'flf2'.$i;?>" value="<?php echo $row_planilla['flf2']; ?>" style="width: 30px; height: 15px; font-size:9px;" maxlength="2"  /></span></div>
<?php }?>
...
?>
		...
		<?php if ($tipofl==1){ ?>
                <td width="30"><div align="center"><span>FLF1</span></div></td>
                <td width="30"><div align="center"><span>FLF2</span></div></td>
		<?php } ?>
...
<?php // INDICADORES SER Y CONOCER
?>
                <td style="border-left:1px solid"><div align="center"><span><select name="<?php echo 'ind1'.$i;?>" id="<? echo 'ind1'.$i;?>"  class="texto_mediano_gris"><option value="">...</option><option value="2">A</option><option value="1">B</option><option value="0">C</option></select></span></div></td>

                <td style="border-left:1px solid"><div align="center"><span><select name="<?php echo 'ind2'.$i;?>" id="<? echo 'ind2'.$i;?>"  class="texto_mediano_gris"><option value="">...</option><option value="2">A</option><option value="1">B</option><option value="0">C</option></select></span></div></td>

                <td style="border-left:1px solid"><div align="center"><span><select name="<?php echo 'ind3'.$i;?>" id="<? echo 'ind3'.$i;?>"  class="texto_mediano_gris"><option value="">...</option><option value="2">A</option><option value="1">B</option><option value="0">C</option></select></span></div></td>

                <td style="border-left:1px solid"><div align="center"><span><select name="<?php echo 'indtotal'.$i;?>" id="<? echo 'indtotal'.$i;?>"  class="texto_mediano_gris"><option value="">...</option><option value="2">A</option><option value="1">B</option><option value="0">C</option></select></span></div></td>
...
?>
		<?php if ($tipofl==1){ ?>
                ...
                <td style="border-left:1px solid; background-color:green;"><div align="center"><span><input name="<?php echo 'flf2'.$i;?>" type="text" id="<? echo 'flf2'.$i;?>" style="width: 30px; height: 15px; font-size:9px;" maxlength="2" /></span></div></td>
