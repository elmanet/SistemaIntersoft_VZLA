...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Planilla Cargada con Exito!</h2>
	<h3>Vuelva a seleccionar la Asignatura si deseas CARGAR CALIFICACIONES... </h3>
	<form action="../docente/verificar_planilla_notas.php" method="POST" name="f1">
	...
	<tr><td>
		<h4>Puedes escoger otra asignatura, para configurar tambien la planilla de Calificaciones o simplemente seleccionar la misma para subir las calificaciones al sistema! </h4>
	</td></tr>
	</form>
<tr><td>
&nbsp;&nbsp;
