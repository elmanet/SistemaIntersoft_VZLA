...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE sis_alumno_info SET nombre=%s, apellido=%s, indicador_nacionalidad=%s, fecha_nacimiento_dia=%s, fecha_nacimiento_mes=%s, fecha_nacimiento_ano=%s, lugar_nacimiento=%s, direccion_vivienda=%s, telefono_alumno=%s, ano_cursar=%s, cedula_representante=%s, nombre_representante=%s, apellido_representante=%s, parentesco_representante=%s, direccion_representante=%s, telefono_representante=%s, email_representante=%s, descripcion_trabajo=%s, direccion_trabajo=%s, telefono_trabajo=%s, nombre_madre=%s, apellido_madre=%s, tel_madre=%s, direccion_madre=%s, nombre_padre=%s, apellido_padre=%s, tel_padre=%s, direccion_padre=%s, ingreso_familiar=%s, vecino1_nombre=%s, vecino1_parentesco=%s, vecino1_telefono=%s, vecino2_nombre=%s, vecino2_parentesco=%s, vecino2_telefono=%s, seguro_posee=%s, seguro_nombre=%s, seguro_clinica=%s, tipo_sangre=%s, alergico=%s, creado=%s WHERE alumno_id=%s",
  ...
  $updateGoTo = "inscripcion_formal1_planilla3.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_sistemacol, $sistemacol);
$query_preinscripcion = sprintf("SELECT * FROM sis_alumno_preinscripcion WHERE cedula = %s", GetSQLValueString($colname_preinscripcion, "int"));
                    ...
                    <td colspan="3" align="center" valign="top" nowrap class="texto_mediano_gris"><fieldset style="background-color:#FFC">
                      <legend class="texto_mediano_grande" ><strong><em>DATOS PERSONALES DEL ESTUDIANTE</em></strong>
                            ...
                            <table width="318" border="0">
                              <tr>
                                <td width="44"><select name="indicador_nacionalidad" class="texto_mediano_gris" id="indicador_nacionalidad">
                                  <option value="V" <?php if (!(strcmp("V", $row_alumno_info['indicador_nacionalidad']))) {echo "selected=\"selected\"";} ?>>V</option>
                                  <option value="E" <?php if (!(strcmp("E", $row_alumno_info['indicador_nacionalidad']))) {echo "selected=\"selected\"";} ?>>E</option>
                                  </select></td>
                        ...
                        <tr valign="baseline">
                          ...
                          <td colspan="3" align="left" valign="top" class="textograndes_eloy"><input name="nombre" type="text" class="texto_mediano_gris" id="nombre" value="<?php echo $row_alumno_info['nombre']; ?>" onKeyUp="this.value=this.value.toUpperCase()"></td>
                          </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Apellido del Estudiante:</td>
                          <td colspan="3" align="left" valign="top" class="textograndes_eloy"><input name="apellido" type="text" class="texto_mediano_gris" id="apellido" value="<?php echo $row_alumno_info['apellido']; ?>" onKeyUp="this.value=this.value.toUpperCase()"></td>
                          </tr>
                        <tr valign="baseline">
                          ...
                          <td width="22" align="left" valign="top" class="textograndes_eloy"><label>
                            <input name="fecha_nacimiento_dia" type="text" class="texto_mediano_gris" id="fecha_nacimiento_dia" value="<?php echo $row_alumno_info['fecha_nacimiento_dia']; ?>" size="2" maxlength="2">
                          </label></td>
                          <td width="35" align="left" valign="top" class="textograndes_eloy"> /
                            <input name="fecha_nacimiento_mes" type="text" class="texto_mediano_gris" id="fecha_nacimiento_mes" value="<?php echo $row_alumno_info['fecha_nacimiento_mes']; ?>" size="2" maxlength="2"></td>
                          <td width="287" align="left" valign="top" class="textograndes_eloy">/
                            <input name="fecha_nacimiento_ano" type="text" class="texto_mediano_gris" id="fecha_nacimiento_ano" value="<?php echo $row_alumno_info['fecha_nacimiento_ano']; ?>" size="4" maxlength="4">
                        ...
                        <tr valign="baseline">
                          ...
                          <td colspan="3" align="left" valign="top" class="textograndes_eloy"><span id="sprytextfield4">
                            <label>
                              <input name="lugar_nacimiento" type="text" class="texto_mediano_gris" id="lugar_nacimiento" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['lugar_nacimiento']; ?>">
                            </label>
                            <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
                          </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Direcci&oacute;n:</td>
                          <td colspan="3" align="left" valign="top" class="textograndes_eloy"><textarea name="direccion_vivienda" cols="40" rows="3" class="texto_mediano_gris" id="direccion_vivienda" onKeyUp="this.value=this.value.toUpperCase()"><?php echo $row_alumno_info['direccion_vivienda']; ?></textarea></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Tel&eacute;fono del Estudiante:</td>
                          <td colspan="3" align="left" valign="top" class="textograndes_eloy"><input name="telefono_alumno" type="text" class="texto_mediano_gris" id="telefono_alumno" value="<?php echo $row_alumno_info['telefono_alumno']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
...
do {  
?>
                              <option value="<?php echo $row_ano_curso['descripcion']?>"<?php if (!(strcmp($row_ano_curso['descripcion'], $row_alumno_info['ano_cursar']))) {echo "selected=\"selected\"";} ?>><?php echo $row_ano_curso['descripcion']?></option>
                              <?php
                    ...
                    <td colspan="3" align="center" valign="top" nowrap class="texto_mediano_gris"><fieldset style="background-color:#FFC">
                      ...
                      <table width="500" border="0">
                        <tr valign="baseline">
                          ...
                          <td align="left" valign="top" class="textograndes_eloy"><input name="nombre_representante" type="text" class="texto_mediano_gris" id="nombre_representante" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['nombre_representante']; ?>"></td>
                          </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Apellido del Representante:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="apellido_representante" type="text" class="texto_mediano_gris" id="apellido_representante" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['apellido_representante']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          ...
                          <input name="cedula_representante" type="text" class="texto_mediano_gris" id="cedula_representante" value="<?php echo $row_alumno_info['cedula_representante']; ?>">
                        ...
                        <tr valign="baseline">
                          ...
                          <td align="left" valign="top" class="textograndes_eloy"><label>
                            <input name="parentesco_representante" type="text" class="texto_mediano_gris" id="parentesco_representante" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['parentesco_representante']; ?>">
                          </label></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Direccion de Vivienda:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><label>
                            <textarea name="direccion_representante" cols="40" rows="3" class="texto_mediano_gris" id="direccion_representante" onKeyUp="this.value=this.value.toUpperCase()"><?php echo $row_alumno_info['direccion_vivienda']; ?></textarea>
                          </label></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Tel&eacute;fono:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="telefono_representante" type="text" class="texto_mediano_gris" id="telefono_representante" value="<?php echo $row_alumno_info['telefono_representante']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">E-mail:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="email_representante" type="text" class="texto_mediano_gris" id="email_representante" value="<?php echo $row_alumno_info['email_representante']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Profesi&oacute;n:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="descripcion_trabajo" type="text" class="texto_mediano_gris" id="descripcion_trabajo" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['descripcion_trabajo']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Direcci&oacute;n de Trabajo:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><textarea name="direccion_trabajo" cols="40" rows="3" class="texto_mediano_gris" id="direccion_trabajo" onKeyUp="this.value=this.value.toUpperCase()"><?php echo $row_alumno_info['direccion_trabajo']; ?></textarea></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Tel&eacute;fono del Trabajo:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="telefono_trabajo" type="text" class="texto_mediano_gris" id="telefono_trabajo" value="<?php echo $row_alumno_info['telefono_trabajo']; ?>"></td>
                        </tr>
                      </table>
                      <BR>
                    </fieldset></td>
                    ...
                    <td colspan="3" align="center" valign="top" nowrap class="texto_mediano_gris"><fieldset style="background-color:#FFC">
                      ...
                      <table width="500" border="0">
                        <tr valign="baseline">
                          ...
                          <td align="left" valign="top" class="textograndes_eloy"><input name="nombre_madre" type="text" class="texto_mediano_gris" id="respuesta_secreta15" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['nombre_madre']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Apellido de la Madre:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="apellido_madre" type="text" class="texto_mediano_gris" id="respuesta_secreta16" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['apellido_madre']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Direcci&oacute;n de la Madre:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><textarea name="direccion_madre" cols="40" rows="3" class="texto_mediano_gris" id="respuesta_secreta17" onKeyUp="this.value=this.value.toUpperCase()"><?php echo $row_alumno_info['direccion_madre']; ?></textarea></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Tel&eacute;fono de la Madre:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><label>
                            <input name="tel_madre" type="text" class="texto_mediano_gris" id="tel_madre" value="<?php echo $row_alumno_info['tel_madre']; ?>">
                          </label></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Nombre del Padre:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><label>
                            <input name="nombre_padre" type="text" class="texto_mediano_gris" id="respuesta_secreta18" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['nombre_padre']; ?>">
                          </label></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Apellido del Padre:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="apellido_padre" type="text" class="texto_mediano_gris" id="respuesta_secreta19" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['apellido_padre']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Direcci&oacute;n del Padre:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><textarea name="direccion_padre" cols="40" rows="3" class="texto_mediano_gris" id="respuesta_secreta20" onKeyUp="this.value=this.value.toUpperCase()"><?php echo $row_alumno_info['direccion_padre']; ?></textarea></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Tel&eacute;fono del Padre:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="tel_padre" type="text" class="texto_mediano_gris" id="respuesta_secreta21" value="<?php echo $row_alumno_info['tel_padre']; ?>"></td>
                        </tr>
                      </table>
                      <BR>
                    </fieldset></td>
                    ...
                    <td colspan="3" align="center" valign="top" nowrap class="texto_mediano_gris"><fieldset style="background-color:#FFC">
                      ...
                      <table width="500" border="0">
                        <tr valign="baseline">
                          ...
                          <td align="left" valign="top" class="textograndes_eloy"><label>
                            <select name="ingreso_familiar" class="texto_mediano_gris" id="ingreso_familiar">
                              <option value="de 1.000 a 1.500 Bsf" <?php if (!(strcmp("de 1.000 a 1.500 Bsf", $row_alumno_info['ingreso_familiar']))) {echo "selected=\"selected\"";} ?>>de 1.000 a 1.500 Bsf</option>
                              <option value="de 1.500 a 2.000 Bsf" <?php if (!(strcmp("de 1.500 a 2.000 Bsf", $row_alumno_info['ingreso_familiar']))) {echo "selected=\"selected\"";} ?>>de 1.500 a 2.000 Bsf</option>
                              <option value="de 2.000 a 3.000 Bsf" <?php if (!(strcmp("de 2.000 a 3.000 Bsf", $row_alumno_info['ingreso_familiar']))) {echo "selected=\"selected\"";} ?>>de 2.000 a 3.000 Bsf</option>
                              <option value="de 3.000 a 4.000 Bsf" <?php if (!(strcmp("de 3.000 a 4.000 Bsf", $row_alumno_info['ingreso_familiar']))) {echo "selected=\"selected\"";} ?>>de 3.000 a 4.000 Bsf</option>
                              <option value="mas de 5.000 Bsf" <?php if (!(strcmp("mas de 5.000 Bsf", $row_alumno_info['ingreso_familiar']))) {echo "selected=\"selected\"";} ?>>mas de 5.000 Bsf</option>
                            </select>
                          </label></td>
                        </tr>
                        <tr valign="baseline">
                        ...
                        <tr valign="baseline">
                          ...
                          <td align="left" valign="top" class="textograndes_eloy"><input name="vecino1_nombre" type="text" class="texto_mediano_gris" id="respuesta_secreta26" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['vecino1_nombre']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Parentesco vecino/familiar(1):</td>
                          <td align="left" valign="top" class="textograndes_eloy"><label>
                            <input name="vecino1_parentesco" type="text" class="texto_mediano_gris" id="pregunta_secreta4" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['vecino1_parentesco']; ?>">
                          </label></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Tel&eacute;fono vecino/familiar(1):</td>
                          <td align="left" valign="top" class="textograndes_eloy"><label>
                            <input name="vecino1_telefono" type="text" class="texto_mediano_gris" id="respuesta_secreta27" value="<?php echo $row_alumno_info['vecino1_telefono']; ?>">
                          </label></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Nombre Vecino/familiar(2):</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="vecino2_nombre" type="text" class="texto_mediano_gris" id="respuesta_secreta28" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['vecino2_nombre']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Parentesco vecino/familiar(2):</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="vecino2_parentesco" type="text" class="texto_mediano_gris" id="respuesta_secreta29" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['vecino2_parentesco']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Tel&eacute;fono vecino/familiar(2):</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="vecino2_telefono" type="text" class="texto_mediano_gris" id="respuesta_secreta30" value="<?php echo $row_alumno_info['vecino2_telefono']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          ...
                          <td align="left" valign="top" class="textograndes_eloy"><label>
                            <select name="seguro_posee" class="texto_mediano_gris" id="seguro_posee">
                              <option value="1" <?php if (!(strcmp(1, $row_alumno_info['seguro_posee']))) {echo "selected=\"selected\"";} ?>>Si</option>
                              <option value="0" <?php if (!(strcmp(0, $row_alumno_info['seguro_posee']))) {echo "selected=\"selected\"";} ?>>No</option>
                            </select>
                          </label></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Nombre del Seguro:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="seguro_nombre" type="text" class="texto_mediano_gris" id="respuesta_secreta32" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['seguro_nombre']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">En Caso de Emergencia Llevar a:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="seguro_clinica" type="text" class="texto_mediano_gris" id="respuesta_secreta22" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['seguro_clinica']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Tipo de Sangre:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="tipo_sangre" type="text" class="texto_mediano_gris" id="respuesta_secreta23" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['tipo_sangre']; ?>"></td>
                        </tr>
                        <tr valign="baseline">
                          <td align="right" valign="top" nowrap class="texto_mediano_gris">Alergico(a) a:</td>
                          <td align="left" valign="top" class="textograndes_eloy"><input name="alergico" type="text" class="texto_mediano_gris" id="respuesta_secreta33" onKeyUp="this.value=this.value.toUpperCase()" value="<?php echo $row_alumno_info['alergico']; ?>"></td>
                        </tr>
                      </table>
                      <BR>
                    </fieldset></td>
