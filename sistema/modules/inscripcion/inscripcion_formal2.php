...
<br />
<br />
<h2 style="font-family:verdana; text-shadow: black 0em 0.1em 0.1em ">Formulario Inscripci&oacute;n (paso 3)</h2>
<div id="div_acceso">
 ...
 <form action="inscripcion_formal3.php" id="captchaform" onsubmit="return checkSubmit();" method="GET" enctype="multipart/form-data" target="_self" class="cmxform" >
		...
		<td colspan="2">
				...
				<center>Ahora debes imprimir la planilla de Inscripci&oacute;n y llevarla a la instituci&oacute;n con todos los requisitos correspondientes</center> </div><br />		
		</td> 		
 		</tr>
		<tr>
