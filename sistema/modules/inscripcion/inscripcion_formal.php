...
<br />
<br />
<h2 style="font-family:verdana; text-shadow: black 0em 0.1em 0.1em ">Formulario Inscripci&oacute;n (paso 1)</h2>
<div id="div_acceso">
	
  

 <form action="inscripcion_formal1.php" id="captchaform" onsubmit="return checkSubmit();" method="POST" enctype="multipart/form-data" target="_self" class="cmxform" >
 		<table>
 		<tr>
		<td colspan="2">
