...
$query_inscripcion = sprintf("SELECT * FROM jos_alumno_info WHERE cedula = %s", GetSQLValueString($colname_inscripcion, "text"));
...
<html>
<head>
<title>PLANILLA DE INSCRIPCION | Sistema Intersoft &copy; <?php echo date('Y');?></title>
...
<table  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <?php if (($totalRows_inscripcion > 0) and ($row_inscripcion['status']==0)) { // Show if recordset not empty ?>
          ...
          <tr>
            ...
            <td align="center" valign="middle"><div align="center">
              <table width="100%" border="0" align="left">
                  <tr>
                    <td align="left" valign="bottom"><h3><?php echo $row_colegio['nomcol']; ?></h3></td>
                  </tr>
                  <tr>
...
?> 
                  ...
                  <td align="left" valign="top"><div align="center">
                    <fieldset style="width:90%;">
                      ...
                      <table width="100%" border="0" align="center">
                        <tr>
                          <td align="left" valign="top" class="texto_8pt_negro"><strong>CEDULA:</strong>&nbsp; <?php echo $row_inscripcion['indicador_nacionalidad']; ?>-<?php echo $row_inscripcion['cedula']; ?> <strong>NOMBRE DEL ESTUDIANTE: </strong><?php echo $row_inscripcion['nombre']; ?> <?php echo $row_inscripcion['apellido']; ?> <br><strong>
                              DIRECCION: </strong>&nbsp;<?php echo $row_inscripcion['direccion_vivienda']; ?><strong>
                              TELEFONO: </strong>&nbsp;<?php echo $row_inscripcion['telefono_alumno']; ?> <br>
                              <strong>LUGAR DE NACIMIENTO: </strong></strong><?php echo $row_inscripcion['lugar_nacimiento']; ?>
                              <strong>ESTADO: </strong></strong><?php echo $row_inscripcion['estado']; ?>
                              <strong>FECHA DE NACIMIENTO:</strong>&nbsp;<?php echo $dia."/".$mes."/".$anio; ?><br/ ></td>
                          </tr>
                        </table>
                      </fieldset>
                    </div></td>
                      ...
                      <table width="100%" border="0" align="center">
                        <tr>
                          <td align="left" valign="top" class="texto_8pt_negro"><strong>CEDULA:</strong> <?php echo $row_inscripcion['cedula_representante']; ?> <strong>NOMBRE  REPRESENTANTE: </strong><?php echo $row_inscripcion['nombre_representante']; ?> <?php echo $row_inscripcion['apellido_representante']; ?><strong><br>
                              ...
                              <br />TELEFONO DE TRABAJO: </strong><?php echo $row_inscripcion['telefono_trabajo']; ?></td>
                          </tr>
                        </table>
                      </fieldset>
                    </div></td>
                ...
                <tr>
                  <td align="left" valign="top"><div align="center">
                    <fieldset style="width:90%;">
                      ...
                      <table width="100%" border="0" align="left">
                        <tr>
                          <td align="left" valign="top" class="texto_8pt_negro">
				<strong>CEDULA MADRE:</strong>&nbsp;<?php echo $row_inscripcion['cedula_madre']; ?>
				<strong>NOMBRE MADRE:</strong>&nbsp;<?php echo $row_inscripcion['nombre_madre']; ?> <?php echo $row_inscripcion['apellido_madre']; ?> 
            <br /><strong>DIRECCION MADRE:</strong>&nbsp;<?php echo $row_inscripcion['direccion_madre']; ?> 
            <strong> TELEFONO MADRE: </strong><?php echo $row_inscripcion['tel_madre']; ?> <strong> PROFESION MADRE:</strong>&nbsp;<?php echo $row_inscripcion['profesion_madre']; ?><br>
            ...
            <strong> DIRECCION PADRE: </strong>&nbsp;<?php echo $row_inscripcion['direccion_padre']; ?>
            <strong> TELEFONO PADRE: </strong><?php echo $row_inscripcion['tel_padre']; ?> <strong>PROFESION PADRE:</strong>&nbsp;<?php echo $row_inscripcion['profesion_padre']; ?><br>
                ...
                <tr>
                  <td align="left" valign="top"><div align="center">
                    <fieldset style="width:90%;">
                      ...
                      <table width="100%" border="0" align="left">
                        <tr>
                          <td height="10" align="left" valign="top" class="texto_8pt_negro">
...
- 08 fotografías del estudiante tamaño 3X3 (vigentes y con uniforme).<br>
- 03 fotografías del representante, tamaño 3X3.<br>
- 03 fotocopias de la cédula de identidad del estudiante (amplia y en el centro de la hoja)<br>
- Original y dos (02) fotocopias de la Partida de Nacimiento del Estudiante.<br>
- Solvencia de la biblioteca.<br>
- Solvencia de Coordinación de Evaluación en el caso de estudiantes que presentaron en reparaciones (revisiones).<br>
- Boletín de calificaciones del Tercer Lapso del año inmediato anterior. (Para alumnos regulares del Plantel).<br>
- Notas certificadas si cursaron estudios en otra Institución.<br>
- Para estudiantes a ingresar en Primer año: Certificado de Educación Primaria, Informe Descriptivo de Sexto Grado y Constancia de Conducta.
</td>
                      </tr>
                    <tr>
          ...
          <small>Esta planilla fue impresa a trav&eacute;s del Sistema Intersoft | Software Educativo &copy <?php echo date('Y'); ?></small>
		<?php } // Show if recordset empty ?>
        <br>
    <tr>
	  <td valign="top">
	  <?php $normas=0; ?>
        <?php if (($totalRows_inscripcion > 0) and ($normas==1)) { // Show if recordset not empty ?>
  <p>&nbsp;</p>
      ...
      <td valign="top"><?php if ($totalRows_inscripcion == 0) { // Show if recordset empty ?>
          ...
          <tr>
            <td><div align="center"><img src="../../images/png/atencion.png" width="80" height="72"><br>
              ...
              <span class="titulo_grande_gris">&quot; Error no existen datos&quot;</span><span class="texto_mediano_gris"><br>
                <br>
                Si deseas llenar la planilla para el proceso de Inscripci&oacute;n<br /> lo puedes hacer <a href="inscripcion_formal.php">-->Aqu&iacute;</a></span><br>
            </div></td>
          </tr>
        </table>
        <?php } // Show if recordset empty ?>
        
        <?php if (($totalRows_inscripcion > 0) and ($row_inscripcion['status']>0)) {?>
        <br /><br /><br /><br />
        <div style="color:red; background-color:#fffccc; border:1px solid; padding: 5 5 5 5; border-radius: 8px 8px 8px 8px; -moz-border-radius: 8px; box-shadow: 0 0 4px rgba(0, 0, 0, 0.4); font-size:12px;">
				<h1><img src="../../images/png/atencion.png" alt="" align="middle" width="80">Todav&iacute;a no has actualizado tu Inscripci&oacute;n!</h1>				
				<center>Si deseas actualizar tus datos e imprimir la planilla para el proceso de Inscripci&oacute;n<br /> lo puedes hacer <a href="inscripcion_formal.php">-->Aqu&iacute;</a></center> <br /> </div>
