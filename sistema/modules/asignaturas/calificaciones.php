...
<a href="calificaciones.php?abc=1&us=<?php echo $_GET['us'];?>"><img src="../../images/png/back_f2.png" width="20" height="20" border="0" align="absmiddle">&nbsp;Ver Calificaciones del 1er Lapso</a>
<?php }?>
<?php if($_GET['abc']==3){?>
  
 <a href="calificaciones.php?abc=1&us=<?php echo $_GET['us'];?>"><img src="../../images/png/back_f2.png" width="20" height="20" border="0" align="absmiddle">&nbsp;Ver Calificaciones del 1er Lapso</a>&nbsp;&nbsp;&nbsp;&nbsp;
<a href="calificaciones.php?abc=2&us=<?php echo $_GET['us'];?>"><img src="../../images/png/back_f2.png" width="20" height="20" border="0" align="absmiddle">&nbsp;Ver Calificaciones del 2do Lapso</a>
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#006600" bordercolor="#000000" bordercolordark="#000000" class="fondo_tabla" id="marco_tabla">
		...
		<td width="15" class="texto_pequeno_gris"><div align="center"><span class="texto_pequeno_gris">N1-F1</span></div></td>
                ...
                <td width="15" class="texto_pequeno_gris"><div align="center"><span class="texto_pequeno_gris">A112</span></div></td>
<?php if (($confi=="nor01") or ($confi=="nor02")){ // FORMATOS GENERTALES
?>
...
<span class="texto_pequeno_gris">SISTEMA INTERSOFT | Software Educativo</b></span>
<!--FIN INFO CONSULTA -->
</td>
          </tr>
	</table>
...
<?php if($_GET['abc']==2){?>
  ...
  <p><a href="calificaciones.php?abc=1&us=<?php echo $_GET['us'];?>"><img src="../../images/png/back_f2.png" width="20" height="20" border="0" align="absmiddle">&nbsp;Ver Calificaciones del 1er Lapso</a></p>
  <p><img src="../../images/png/product-big.png" width="64" height="64" /><br />
    <span class="texto_mediano_grande">No se han agregado <br />
     Calificaciones de <?php echo $_GET['abc']; ?> Lapso para este Estudiante...<br />
codfor: <?php echo $confi;?>
    </span></p>
<?php }?>
...
<?php if($_GET['abc']==3){?>
  ...
  <p><a href="calificaciones.php?abc=1&us=<?php echo $_GET['us'];?>"><img src="../../images/png/back_f2.png" width="20" height="20" border="0" align="absmiddle">&nbsp;Ver Calificaciones del 1er Lapso</a></p>
 <p><a href="calificaciones.php?abc=2&us=<?php echo $_GET['us'];?>"><img src="../../images/png/back_f2.png" width="20" height="20" border="0" align="absmiddle">&nbsp;Ver Calificaciones del 2do Lapso</a></p>
  <p><img src="../../images/png/product-big.png" width="64" height="64" /><br />
    <span class="texto_mediano_grande">No se han agregado <br />
      Calificaciones de <?php echo $_GET['abc']; ?> Lapso para este Estudiante...<br />
    </span></p>
