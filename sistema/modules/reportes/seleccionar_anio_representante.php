...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<form action="re_representante.php" method="GET" target="_blank">
	<select name="curso_id" class="texto_mediano_gris" id="curso_id">
	  ...
	  $row_seccion = mysql_fetch_assoc($seccion);
	   ...
	   ?>
         ...
         <span class="texto_mediano_gris">Titulo Opcional &nbsp;</span><input type="text" name="titulo" value="CONTROL DE ASISTENCIA" size="40" /><br />
	<br /><input type="submit" name="buttom" value="Ver Reporte >" />
	</form>
