...
<!--INFORMACION DE LA CONSULTA -->
 ...
 <span class="texto_grande_gris"><b>Estudiantes de <?php echo $row_reporte['anio']." ".$row_reporte['descripcion'];?></b></span><br />

 <br />
     Total de Estudiantes:  <?php echo $totalRows_reporte; ?>
<table width="700" class="fondo_tabla" id="marco_tabla" cellspacing="0" cellpadding="0">
              <tr bgcolor="#00FF99" class="textogrande_eloy">
                <td width="40" class="textogrande_eloy"><div align="center"><span class="texto_mediano_gris"><b>No.</b></span></div></td>
		<td width="100" class="textogrande_eloy"><div align="center"><span class="texto_mediano_gris"><b>C&eacute;dula</b></span></div></td>
                <td width="430" class="textogrande_eloy"><div align="center"><span class="texto_mediano_gris"><b>Apellidos y Nombres</b></span></div></td>
                <td width="30" class="textogrande_eloy"><div align="center"><span class="texto_mediano_gris"><b></b>N1</b></span></div></td>
                <td width="30" class="textogrande_eloy"><div align="center"><span class="texto_mediano_gris"><b></b>N2</b></span></div></td>
                <td width="30" class="textogrande_eloy"><div align="center"><span class="texto_mediano_gris"><b></b>N3</b></span></div></td>
                <td width="30" class="textogrande_eloy"><div align="center"><span class="texto_mediano_gris"><b></b>N4</b></span></div></td>
                <td width="30" class="textogrande_eloy"><div align="center"><span class="texto_mediano_gris"><b></b>N5</b></span></div></td>
                <td width="30" class="textogrande_eloy"><div align="center"><span class="texto_mediano_gris"><b></b>N6</b></span></div></td>
					<td width="30" class="textogrande_eloy"><div align="center"><span class="texto_mediano_gris"><b></b>N7</b></span></div></td>
					<td width="30" class="textogrande_eloy"><div align="center"><span class="texto_mediano_gris"><b></b>N8</b></span></div></td>
              </tr>
              <?php do { ?>
		...
		<td height="26" class="textoVARIOS_eloy"  style="border-left:1px solid"><div align="center"><span class="texto_mediano_gris"><?php echo $row_reporte['cedula']; ?></span></div></td>
                ...
                <td class="textoVARIOS_eloy" style="border-left:1px solid"><div align="center"><span class="texto_mediano_gris"><?php if($row_reporte['status']==3){ echo "<span style='color:red;'><b>R</b></span>";} ?></span></div></td>
					<td class="textoVARIOS_eloy" style="border-left:1px solid"><div align="center"><span class="texto_mediano_gris"><?php if($row_reporte['status']==3){ echo "<span style='color:red;'><b>R</b></span>";} ?></span></div></td>
					<td class="textoVARIOS_eloy" style="border-left:1px solid"><div align="center"><span class="texto_mediano_gris"><?php if($row_reporte['status']==3){ echo "<span style='color:red;'><b>R</b></span>";} ?></span></div></td>
					<td class="textoVARIOS_eloy" style="border-left:1px solid"><div align="center"><span class="texto_mediano_gris"><?php if($row_reporte['status']==3){ echo "<span style='color:red;'><b>R</b></span>";} ?></span></div></td>
					<td class="textoVARIOS_eloy" style="border-left:1px solid"><div align="center"><span class="texto_mediano_gris"><?php if($row_reporte['status']==3){ echo "<span style='color:red;'><b>R</b></span>";} ?></span></div></td>
