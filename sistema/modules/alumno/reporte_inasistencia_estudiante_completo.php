...
mysql_select_db($database_sistemacol, $sistemacol);
$query_inasistencia = sprintf("SELECT b.inasistencia_alumno, b.justificativo, b.fecha_inasistencia, d.nombre as mate FROM jos_alumno_info a, jos_alumno_asistencia b, jos_asignatura c, jos_asignatura_nombre d WHERE a.alumno_id=b.alumno_id AND b.asignatura_id=c.id AND c.asignatura_nombre_id=d.id AND a.cedula = %s ORDER BY mate, fecha_inasistencia ASC", GetSQLValueString($colname_inasistencia, "text"));
...
<center>				
          ...
          <tr>
            <td colspan="3" valign="top"><div align="center">
              <hr>
              <span class="texto_grande_gris"><strong>REPORTE DE INASISTENCIAS DE ESTUDIANTE</strong></span>
              <hr>
              </div>
