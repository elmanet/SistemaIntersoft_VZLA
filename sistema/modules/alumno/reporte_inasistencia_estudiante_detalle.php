...
<center>
<body>
<?php if ($row_usuario['gid']>=19){ // AUTENTIFICACION DE USUARIO 
?>
...
<table style="font-size:10px; font-family:verdana;" width="100%" BORDER="1" BORDERCOLOR="#fffccc" CELLSPACING="0" >
	...
	<tr >
		...
		<td align="left" width="200"><?php echo $row_alumno['apellido'].", ".$row_alumno['nombre']; ?></td>
		...
		<a href="reporte_inasistencia_estudiante_detalle2.php?cedula=<?php echo $row_alumno['cedula'];?>"><img src="../../images/png/32px-Crystal_Clear_app_filetypes.png" width="25"  alt="" border="0" align="absmiddle"></a>
