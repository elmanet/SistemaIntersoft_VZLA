...
mysql_select_db($database_sistemacol, $sistemacol);
$query_alumno = sprintf("SELECT a.id, a.username, a.password, a.gid FROM jos_users a, jos_alumno_info b WHERE a.id=b.joomla_id AND a.username = %s", GetSQLValueString($colname_alumno, "text"));
...
<td>
	...
	<input name="username" type="hidden" id="username" value="<?php echo $row_alumno['username']; ?>">
