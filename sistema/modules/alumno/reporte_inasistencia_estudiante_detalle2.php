...
if (isset($_GET['cedula'])) {
  $colname_estudiante = $_GET['cedula'];
}
mysql_select_db($database_sistemacol, $sistemacol);
$query_estudiante = sprintf("SELECT a.cedula, a.nombre, a.apellido, a.indicador_nacionalidad, a.direccion_vivienda, a.telefono_alumno, d.descripcion, e.nombre as anio FROM jos_alumno_info a, jos_alumno_curso b, jos_curso c, jos_seccion d, jos_anio_nombre e WHERE a.alumno_id=b.alumno_id AND b.curso_id=c.id AND c.seccion_id=d.id AND c.anio_id=e.id AND a.cedula = %s", GetSQLValueString($colname_estudiante, "text"));
...
<form action="reporte_inasistencia_estudiante_detalle.php" name="form" id="form" method="GET" enctype="multipart/form-data" >
...
<br />
&nbsp;&nbsp;&nbsp;<a href="reporte_inasistencia_estudiante_detalle.php" > | Ver Todos los Estudiantes |</a>
<br />
<br />				
				</td>			
			</tr>
 ...
 <center>                         
                          <table style="font-size:10px; font-family:verdana;" width="50%" BORDER="1" BORDERCOLOR="#fffccc" CELLSPACING="0" >
	...
	do { ?>
	<tr >
		<td align="center" width="150"><a href="JavaScript:newPopup('reporte_inasistencia_estudiante_asignatura.php?cedula=<?php echo $_GET['cedula'];?>&id=<?php echo $row_inasistencia['id'];?>');" ><?php echo $row_inasistencia['mate']; ?></a></td>
