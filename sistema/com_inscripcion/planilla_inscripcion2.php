...
<div id="contenedor">
	<div id="contenido">
	 <?php if($_GET['cedula']>0){?>
		...
		<p> Ahora puede imprimir la planilla de inscripcion del Estudiante o seguir con el registro de Estudiantes...</p>
		<?php }?>		
		<h3>Imprimir Planilla de Inscripcion</h3>
		<form action="planilla_inscripcion_ficha.php" method="GET" target="_blank">		
			<table><tr><td>		   
					<tr><td>Cedula del Estudiante:</td><td><input type="text" name="cedula" value="<?php echo $_GET['cedula']; ?>" /></td><td><input type="submit" name="boton" value="Imprimir Planilla" /></td></tr>
