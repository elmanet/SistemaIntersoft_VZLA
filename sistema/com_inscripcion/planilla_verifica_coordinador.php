...
<center>
<br>
<img src="../images/pngnew/usuario-administrador-personal-icono-9746-128.png"  alt="" align="middle"/>
<h2> Registro de Coordinadores y Secretarias </h2>

<form action="planilla_registro_coordinador1.php" method="GET" id="verificar_alumno">
	<table width="600px"><tr><td style="color:#blue; background-color: #fffccc;" colspan="2" align="center"><h3>Verificacion de Registro</h3></td></tr>
		<tr><td align="right">Cedula del Coordinador o Secretaria:</td>
...
<br>
<a href="../modules/acceso/index.php" >-Volver al menú Principal-</a>
</center>
