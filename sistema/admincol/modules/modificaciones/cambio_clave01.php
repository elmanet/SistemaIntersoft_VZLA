...
if (isset($_POST['username'])) {
  $colname_docente = $_POST['username'];
}
mysql_select_db($database_sistemacol, $sistemacol);
$query_docente = sprintf("SELECT id, username, password FROM jos_users WHERE username = %s", GetSQLValueString($colname_docente, "text"));
...
<?php if ($totalRows_docente>0){ // INICIO DE LA CONSULTA
?>
...
<table width="450" border="0">
  <tr>
    ...
    <td width="362"><table width="100%" border="0">
      <tr>
        <td class="titulo_extragrande_gris" colspan="2">Cambiar Clave de Acceso</td>
      </tr>
      <tr><td>
	Cambiar clave para el usuario: <b> <?php echo $row_docente['username'];?></b>
