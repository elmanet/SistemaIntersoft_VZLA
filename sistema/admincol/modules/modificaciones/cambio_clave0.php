...
<table width="600" border="0">
  <tr>
    ...
    <td width="362"><table width="100%" border="0">
      <tr>
        <td class="titulo_extragrande_gris" colspan="2">Cambiar de Acceso de Usarios</td>
      </tr>
      <tr><td>
	
	<form action="cambio_clave01.php" method="POST" name="form1">
	<table>
            <tr><td align="right" class="texto_mediano_gris">Nombre de Usuario o C&eacute;dula:</td></tr>
            <tr>
	<td><span ><label><input type="username" name="username" value="" id="username"  class="texto_mediano_gris" />
      
            </label></span></td</tr>
            <tr><td align="right">
            <input class="texto_mediano_gris" type="submit" name="buttom" value="Modificar >" /></td></tr>
        </table>
