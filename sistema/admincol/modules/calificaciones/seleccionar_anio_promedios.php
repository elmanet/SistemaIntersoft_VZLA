...
$query_seccion = sprintf("SELECT id, nombre FROM jos_anio_nombre ORDER BY numero_anio ASC");
...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<form action="reporte_promedios_anio.php" method="GET" target="_blank">
	<select name="id" class="texto_mediano_gris" id="curso_id">
	...
	<input type="hidden" name="lapso" value="<?php echo $row_lapso['cod']; ?>"/>
...
<p align="center">"Selecciona el A&ntilde;o a consultar..." </p>
</div>
</div>
	</td></tr>
