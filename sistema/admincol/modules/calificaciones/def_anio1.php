...
<tr><td>
<form action="def_anio2.php" name="form" id="form" method="POST" enctype="multipart/form-data" target="_blank">
<div id="recuadro_cedula"><br />
<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Reporte Definitivas!</h2>
...
<input type="submit" name="buttom" value="Ver >" />
</div>
</form>  	
<tr><td>
&nbsp;&nbsp;
