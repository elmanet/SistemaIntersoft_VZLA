...
<h1><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Calificaciones Modificadas con Exito!</h1>
...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h3>Selecciona otra Asignatura para modificar Calificaciones... </h3>
	<form action="modificar_notas_parcial.php" method="POST" name="f1">
...
<table width="700" style="font-size:9px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#006600" bordercolor="#000000" bordercolordark="#000000" class="fondo_tabla" id="marco_tabla">
		...
		<td height="26"  style="border-left:1px solid"><div align="center"><span><?php if($row_planilla['def']==0){ echo "NC"; } else { echo $row_planilla['def'];} ?></span></div></td>
