...
<table width="700" style="font-size:9px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#006600" bordercolor="#000000" bordercolordark="#000000" class="fondo_tabla" id="marco_tabla">
		...
		<td width="80"><div align="center"><span>N1f1</span></div></td>
                <td width="80"><div align="center"><span>A112</span></div></td>
                ...
                <td width="80"><div align="center"><span>A112</span></div></td>
                <td width="80"><div align="center"><span>S/C</span></div></td>
               <?php /*
		...
		*/ ?>
		...
		do {   ?>
              <tr bgcolor="#FFFFFF" class="texto_mediano_gris">
                ...
                <td style="border-left:1px solid"><div align="center"><span><input name="p6f1" type="text" id="p6f1" value="<?php echo $row_planilla['p6f1']; ?>" style="width: 30px; height: 15px; font-size:9px;" /></span></div></td>
<?php /* 
