...
mysql_select_db($database_sistemacol, $sistemacol);
$query_alumno = sprintf("SELECT b.indicador_nacionalidad, b.apellido, b.nombre, b.cedula, e.nombre as anio, f.descripcion, h.nombre_proyecto FROM jos_formato_evaluacion_bol02 a, jos_alumno_info b, jos_curso d, jos_anio_nombre e, jos_seccion f, jos_alumno_curso g, jos_formato_evaluacion_planilla h WHERE a.alumno_id=b.alumno_id AND b.alumno_id=g.alumno_id AND g.curso_id=d.id AND d.seccion_id=f.id AND d.anio_id=e.id AND a.confiplanilla_id=h.id AND b.cedula = %s AND a.lapso = %s", GetSQLValueString($colname_alumno, "bigint"), GetSQLValueString($lapso_alumno, "int"));
...
mysql_select_db($database_sistemacol, $sistemacol);
$query_asignatura1 = sprintf("SELECT c.nombre, a.def FROM jos_formato_evaluacion_bol02 a, jos_asignatura b, jos_asignatura_nombre c, jos_alumno_info d WHERE a.alumno_id=d.alumno_id AND a.asignatura_id=b.id AND b.asignatura_nombre_id=c.id  AND d.cedula = %s AND a.lapso = 1 ORDER BY b.orden_asignatura ASC" , GetSQLValueString($colname_asignatura1, "bigint"));
...
mysql_select_db($database_sistemacol, $sistemacol);
$query_asignatura2 = sprintf("SELECT * FROM jos_formato_evaluacion_bol02 a, jos_asignatura b, jos_asignatura_nombre c, jos_alumno_info d WHERE a.alumno_id=d.alumno_id AND a.asignatura_id=b.id AND b.asignatura_nombre_id=c.id  AND d.cedula = %s AND a.lapso = 2 ORDER BY b.orden_asignatura ASC" , GetSQLValueString($colname_asignatura2, "bigint"));
...
mysql_select_db($database_sistemacol, $sistemacol);
$query_asignatura3 = sprintf("SELECT * FROM jos_formato_evaluacion_bol02 a, jos_asignatura b, jos_asignatura_nombre c, jos_alumno_info d WHERE a.alumno_id=d.alumno_id AND a.asignatura_id=b.id AND b.asignatura_nombre_id=c.id  AND d.cedula = %s AND a.lapso = 3 ORDER BY b.orden_asignatura ASC" , GetSQLValueString($colname_asignatura3, "bigint"));
...
mysql_select_db($database_sistemacol, $sistemacol);
$query_asignatura_final = sprintf("SELECT ROUND(AVG(a.def),0) as def FROM jos_formato_evaluacion_bol02 a, jos_asignatura b, jos_asignatura_nombre c, jos_alumno_info d WHERE a.alumno_id=d.alumno_id AND a.asignatura_id=b.id AND b.asignatura_nombre_id=c.id  AND d.cedula = %s GROUP BY a.alumno_id, c.nombre ORDER BY b.orden_asignatura ASC" , GetSQLValueString($colname_asignatura_final, "bigint"));
...
<?php if($totalRows_asignatura1>0) { ?>
<table border="0"  style="width:17cm; ">
  <tr><td>
  <img src="../../images/logo_ce_2013.jpg" width="100%" alt="" />
  <table style="margin:0 0 0 0;">
	<tr>
    <td width="429" align="left"><img src="../../images/logo_coordinacion.jpg" width="200" height="51" border="0"></td>
...
<?php echo $row_colegio['dircol']; ?></span></td>
  ...
  <tr>
    <td colspan="3" align="center"><h2>INFORME DE ACTUACION DEL ESTUDIANTE <?php if($_GET['lapso']==1){echo "I";} if($_GET['lapso']==2){echo "II";} if($_GET['lapso']==3){echo "III";} ?> LAPSO </h2> 
    <h3> A&Ntilde;O ESCOLAR : <?php echo $row_confi1['descripcion'];?></h3></td>
  </tr>
  <tr>
...
*/?>
  ...
  <?php if($totalRows_mate153>0){?>
	<tr>
	 ...
	 <td height="20" align="center" ><span ><b><?php if($row_mate153['def']==0){ echo 'NC';}?> <?php if(($row_mate153['def']>0) and ($row_mate153['def']<10)) { echo "0".$row_mate153['def']; }?> <?php if($row_mate153['def']>9){ echo $row_mate153['def']; }?></b></span></td>
	 </tr>
	 <?php } ?>    
    ...
    <!--     <td align="center" height="20">
	 ...
	 <td height="20" align="center"><span ><b><?php if($row_mate143['def']==0){ echo 'NC';}?> <?php if(($row_mate143['def']>0) and ($row_mate143['def']<10)) { echo "0".$row_mate143['def']; }?> <?php if($row_mate143['def']>9){ echo $row_mate143['def']; }?></b></span></td>
         <?php } ?>              
              </tr>
               </table>
...
<?php } ?>
 ...
 <td align="center">
    <table border="1" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#000000" bordercolordark="#000000" class="texto_pequeno_gris" style="width:4cm">
      <tr>
        
        <td align="center" bgcolor="#fffccc" valign="middle"><strong><span class="texto_mediano_gris">TOTAL DE INASISTENCIAS</span></strong></td>
	<?php /* <td align="center" valign="middle"><strong><span class="texto_mediano_gris">%</span></strong></td> */?>
        </tr>
   
      <tr>
       <td align="center" bgcolor="#fff" colspan="2"  valign="middle" class="texto_grande_gris">&nbsp;<?php if($totalRows_inasistencia>0){echo $row_inasistencia['inasistencia_alumno'];}else{echo "0";}?>&nbsp;</td>
...
echo $porcentaje."%";}else{echo "0%";}?></td>*/?>
      ...
      <tr>
        <td  align="center" bgcolor="#fffccc" valign="middle"><strong><span class="texto_mediano_gris">PROMEDIO DE LAPSO</span></strong></td>        </tr>
      <tr>
        <td align="center" bgcolor="#fff"  valign="middle"><strong><span class="texto_grande_gris"><?php 
           $lapso=$_GET['lapso'];   
           if($lapso==1) {        
           $ept=$row_mate141['def'];
           }
      ...
      <tr>
        <td  align="center" bgcolor="#fffccc" valign="middle"><strong><span class="texto_mediano_gris">POSICI&Oacute;N GENERAL DE LA INSTITUCI&Oacute;N</span></strong></td>        
        </tr>
      <tr>
        <td align="center" bgcolor="#fff"  valign="middle"><strong><span class="texto_grande_gris">
...
<?php $num=$num-1;} while ($row_posicion = mysql_fetch_assoc($posicion)); ?>
        ...
        <tr>
        <td  align="center" bgcolor="#fffccc" valign="middle"><strong><span class="texto_mediano_gris">POSICI&Oacute;N EN LA SECCI&Oacute;N</span></strong></td>        
        </tr>
      <tr>
        <td align="center" valign="middle"  bgcolor="#fff" ><strong><span class="texto_grande_gris">
...
echo $porcentaje."%";}else{echo "0%";}?></td>*/?>
  ...
  <tr>
        ...
        <!--<td width="300" valign="top"><table style="border:1px solid" style="width:10cm; margin-left:0">
          <tr>
  ...
  <tr>
    <td colspan="3" align="center"><p>&nbsp;</p>
      ...
      <tr class="texto_mediano_gris">
        <td align="center">FIRMA EVALUADOR</td>
        <td align="center">&nbsp;</td>
        <td align="center">FIRMA DOCENTE GUIA</td>
        <td align="center">&nbsp;</td>
        <td align="center">FIRMA DEL DIRECTOR</td>
      </tr>
    </table></td>
  </tr>
</table>
...
<center>
<img src="../../images/png/atencion.png" alt="" >
<h2>No se han cargado calificaciones para este Estudiante</h2>
</center>
<?php } ?>
<br />
<br />
<br />
<br />
<span style="font-family:arial; font-size:10px;">Intersoft | Software Educativo &copy; 2002-2012</span>
</center>
</div>
</body>
</html>