...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Agregar Secci&oacute;n a N&oacute;mina!</h2>
        <h3>Selecciona la Asignatura para agregar secci&oacute;n... </h3>
	<form action="agregar_seccion_planillanotas.php" method="POST" name="f1" target="_blank">
	</td></tr><tr><td><img src="../../images/gif/construccion-plantilla.gif" width="20" height="20" border="0" align="absmiddle">&nbsp;&nbsp;
                    <select name="asignatura_id" class="texto_mediano_gris" id="asignatura_id">
	  ...
	  $row_docente = mysql_fetch_assoc($docente);
	   ...
	   ?>
                    ...
                    <select name="lapso" id="lapso" class="texto_mediano_gris">
...
<p align="center">"Selecciona la Asignatura, a&ntilde;o, secci&oacute;n y el lapso." <br /><br /><b>Nota:</b> Este m&oacute;dulo se utiliza cuando se van a cargar s&oacute;lo las definitivas para alguna asignatura de una secci&oacute;n. </p>
</div>
</div>
	</td></tr>
	</form>
