...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Cargar Calificaciones Definitivas!</h2>
	<h3>Selecciona la Asignatura a cargar Calificaciones... </h3>
	<form action="cargar_notas_definitivas1.php" method="POST" name="f1" target="_blank" >
...
<p align="center">"Para cargar las Definitivas debes tener cargada la n&oacute;mina de calificaciones en la base de datos esto se hace presionando click en <b>Agregar secci&oacute;n a n&oacute;mina</b> que se encuentra en el anterior menu"</p>
</div>
</div>
	</td></tr>
	</form>
