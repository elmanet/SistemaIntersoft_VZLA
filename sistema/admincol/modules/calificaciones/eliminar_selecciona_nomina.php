...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Eliminar Estudiantes Duplicados!</h2>
	<h3>Selecciona la Asignatura a eliminar Estudiantes... </h3>
	<form action="eliminar_estudiante_nomina.php" method="POST" name="f1" target="_blank" >
...
<p align="center">"Esta opci&oacute;n se utiliza cuando deseamos eliminar estudiantes duclicados en la n&oacute;mina de calificaciones"</p>
</div>
</div>
	</td></tr>
	</form>
