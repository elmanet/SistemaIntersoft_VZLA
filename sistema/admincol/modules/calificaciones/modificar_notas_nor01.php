...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "modi_form")) {
	$updateSQL = sprintf("update jos_formato_evaluacion_nor01 SET p1f1=%s, p1f2=%s, p2f1=%s, p2f2=%s, p3f1=%s, p3f2=%s, p4f1=%s, p4f2=%s, p5f1=%s, p5f2=%s, sumanotas=%s, sumapon=%s, calpro=%s, def=%s WHERE id=%s",
                            ...
                            GetSQLValueString($p5f1, "double"),
                            GetSQLValueString($p5f2, "double"),
...
<table width="700" style="font-size:9px" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#006600" bordercolor="#000000" bordercolordark="#000000" class="fondo_tabla" id="marco_tabla">
		...
		<td width="80"><div align="center"><span>N1f1</span></div></td>
                ...
                <td width="80"><div align="center"><span>N5f1</span></div></td>
                <td width="80"><div align="center"><span>N5f2</span></div></td>
               <?php /*
		<td width="80"><div align="center"><span>flf1</span></div></td>
                <td width="80"><div align="center"><span>flf2</span></div></td>
		*/ ?>
              </tr>
		...
		do {   ?>
              <tr bgcolor="#FFFFFF" class="texto_mediano_gris">
                ...
                <td style="border-left:1px solid"><div align="center"><span><input name="p5f1" type="text" id="p5f1" value="<?php echo $row_planilla['p5f1']; ?>" style="width: 30px; height: 15px; font-size:9px;" /></span></div></td>
                <td style="border-left:1px solid"><div align="center"><span><input name="p5f2" type="text" id="p5f2" value="<?php echo $row_planilla['p5f2']; ?>" style="width: 30px; height: 15px; font-size:9px;" /></span></div></td>
<?php /* 
                <td style="border-left:1px solid"><div align="center"><span><input name="flf1" type="text" id="flf1" value="<?php echo $row_planilla['flf1']; ?>" style="width: 30px; height: 15px; font-size:9px;" /></span></div></td>
                <td style="border-left:1px solid"><div align="center"><span><input name="flf2" type="text" id="flf2" value="<?php echo $row_planilla['flf2']; ?>" style="width: 30px; height: 15px; font-size:9px;" /></span></div></td>
*/?>

                <input type="hidden" name="id"  id="id" value="<?php echo $row_planilla['id']; ?>" >
		<input type="hidden" name="indtotal"  id="indtotal" value="<?php echo $row_planilla['indtotal']; ?>" >
