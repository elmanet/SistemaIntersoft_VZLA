...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Modificar Calificaciones Parciales!</h2>
	<h3>Selecciona la Asignatura a modificar... </h3>
	<form action="modificar_notas_parcial.php" method="POST" name="f1" target="_blank" >
...
<p align="center">"Para modificar las calificaciones parciales debes tener cargada la n&oacute;mina de calificaciones en la base de datos, sino tienes informaci&oacute;n al respecto puedes cargar S&oacute;lo las Definitivas en el enlace del menu anterior"</p>
</div>
</div>
	</td></tr>
	</form>
