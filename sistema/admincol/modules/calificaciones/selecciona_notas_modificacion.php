...
mysql_select_db($database_sistemacol, $sistemacol);
$query_docente = sprintf("SELECT a.id as curso, b.descripcion, c.nombre as anio FROM jos_curso a, jos_seccion b, jos_anio_nombre c WHERE   a.seccion_id=b.id AND a.anio_id=c.id ORDER BY  c.numero_anio, b.id ASC", GetSQLValueString($colname_docente, "text"));
...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign="top">
        ...
        <h3><b>Paso 1. </b></h3><span class="texto_grande_gris">Selecciona el a&ntilde;o que cursa el Estudiante</span><br /><br />
	<form action="selecciona_notas_modificacion2.php" method="POST" name="f1">
         ...
         <option value="">..Selecciona</option>
           <?php do { ?>
              <option value="<?php echo $row_docente['curso']; ?>"><?php echo $row_docente['anio']." ".$row_docente['descripcion']; ?></option>
	  ...
	  $row_docente = mysql_fetch_assoc($docente);
	   ...
	   ?>
              ...
              <input type="hidden" id="lap" name="lap" value="<?php echo $row_lapso['cod'];?>"/>
