...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Planilla de Resumen de Lapso!</h2>
	<h3>Selecciona la Asignatura para visualizar las calificaciones... </h3>
	<form action="ver_notas_<?php echo $row_confi['codfor']; ?>.php" method="GET" name="f1" target="_blank">
...
<p align="center">"Selecciona la Asignatura, a&ntilde;o, secci&oacute;n y el lapso a consultar..."</p>
</div>
</div>
	</td></tr>
	</form>
