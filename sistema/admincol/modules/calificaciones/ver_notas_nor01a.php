            ...
            <td colspan="2" align="center" valign="top" class="titulosgrandes_eloy"><table border="0">
              <tr>
                <td width="2507" height="40" align="center"><table width="1200" border="1" align="left" cellpadding="0" cellspacing="0" bordercolor="#000000" bordercolordark="#000000">
                  <tr>
                      <td colspan="26" align="left" class="texto_pequeno_gris"><table width="1200" border="0" align="center">
                        <tr>
                  ...
                  <tr>
                   ...
                   <?php /* <td width="40" rowspan="6" align="center" class="texto_pequeno_gris"><strong>&nbsp;70%&nbsp;</strong></td>
                  ...
                  <tr>
                   ...
                   <?php /* <td width="40" height="6" align="center" class="texto_pequeno_gris"><strong>F1</strong></td>
                    ...
                    <tr >
                      ...
                      <?php /*  <td align="center" class="texto_pequeno_gris"><?php if($row_planilla['seten']==(int)0.00 && $row_planilla['seten']!==null){ echo '';} else { echo $row_planilla['seten'];} ?></td>
