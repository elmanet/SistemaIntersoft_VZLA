...
if($_POST['apellido_docente_ept']==!NULL){
  ...
  $insertSQL = sprintf("INSERT INTO jos_cdc_resumen_docente (id, curso_id, tipo_resumen, tipo_cedula, nombre_mate, orden_mate, nombre_docente, apellido_docente, cedula_docente) VALUES ( %s, %s,  %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['nombre_docente_ept'], "text"),
                       GetSQLValueString($_POST['apellido_docente_ept'], "text"),
                       GetSQLValueString($_POST['cedula_docente_ept'], "bigint"));
...
if (isset($_POST['cedula'.$i])) {
  $colname_estudiante = $_POST['cedula'.$i];
}
mysql_select_db($database_sistemacol, $sistemacol);
$query_estudiante = sprintf("SELECT * FROM jos_cdc_estudiante WHERE cedula=%s", GetSQLValueString($colname_estudiante, "bigint"));
...
$fecha_nac= $_POST['ano'.$i]."-".$_POST['mes'.$i]."-".$_POST['dia'.$i];
  ...
  mysql_select_db($database_sistemacol, $sistemacol);
  $Result6 = mysql_query($insertSQL, $sistemacol) or die(mysql_error());
}
...
$fecha_nac= $_POST['ano'.$i]."-".$_POST['mes'.$i]."-".$_POST['dia'.$i];
     ...
     $updateSQL = sprintf("update jos_alumno_info SET nombre=%s, apellido=%s, lugar_nacimiento=%s, ef=%s, sexo=%s, fecha_nacimiento=%s, estado=%s WHERE alumno_id=%s",
...
mysql_select_db($database_sistemacol, $sistemacol);
$query_profe_mate = sprintf("SELECT * FROM jos_asignatura a, jos_asignatura_nombre b, jos_docente c WHERE a.asignatura_nombre_id=b.id AND a.docente_id=c.id AND a.tipo_asignatura='' AND b.condicion=1 AND a.curso_id=%s ORDER BY a.orden_asignatura ASC", GetSQLValueString($colname_profe_mate, "int"));
...
&nbsp;&nbsp;<input type="text" class="texto_pequeno_gris" name="<?php echo 'apellido'.$i; ?>" value="<?php echo $row_mate1['apellido']; ?>" />
</td>
<td  class="ancho_td_nombre3"style="border-right:1px solid; border-bottom:1px solid;" >
&nbsp;&nbsp;<input type="text" class="texto_pequeno_gris" name="<?php echo 'nombre'.$i; ?>" value="<?php echo $row_mate1['nombre']; ?>" />
</td>
<td  class="ancho_td_nombre3"style="border-right:1px solid; border-bottom:1px solid;" >
&nbsp;&nbsp;<input type="text" class="texto_pequeno_gris" name="<?php echo 'lugar_nacimiento'.$i; ?>" value="<?php echo $row_mate1['lugar_nacimiento']; ?>" />
</td>
<td class="ancho_td_no3" style="border-right:1px solid; border-bottom:1px solid;" align="center">
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
<input type="text" size="2"  name="<?php echo 'm1'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate1def['def']; ?>"/>
</td>
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
<input type="text" size="2"  name="<?php echo 'm2'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate2def['def']; ?>"/>
</td>
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
<input type="text" size="2"  name="<?php echo 'm3'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate3def['def']; ?>"/>
</td>
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
<input type="text" size="2"  name="<?php echo 'm4'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate4def['def']; ?>"/>
</td>
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
<input type="text" size="2"  name="<?php echo 'm5'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate5def['def']; ?>"/>
</td>
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
<input type="text" size="2"  name="<?php echo 'm6'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate6def['def']; ?>"/>
</td>
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
<input type="text" size="2"  name="<?php echo 'm7'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate7def['def']; ?>"/>
</td>
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
<input type="text" size="2"  name="<?php echo 'm8'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate8def['def']; ?>"/>
</td>
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid; " align="center" >
<input type="text" size="2"  name="<?php echo 'm9'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate9def['def']; ?>"/>
</td>
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
<input type="text" size="2"  name="<?php echo 'm10'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate10def['def']; ?>"/>
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
<input type="text" size="2"  name="<?php echo 'm11'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate11def['def']; ?>"/>
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
<input type="text" size="2"  name="<?php echo 'm12'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate12def['def']; ?>"/>
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
<input type="text" size="2"  name="<?php echo 'm13'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate13def['def']; ?>"/>
...
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
<input type="text" size="2"  name="<?php echo 'm14'.$i; ?>" class="texto_pequeno_gris" value="<?php echo $row_mate14def['def']; ?>"/>
...
<td  class="ancho_td_no" style="border-bottom:1px solid; border-right:1px solid; background-color:#fffccc;" align="center" >
ET1<br />
<input type="checkbox" name="checkbox1" value="checkbox" onClick="todos_ept1(this);"> 
</td>
<td  class="ancho_td_no" style="border-bottom:1px solid; border-right:1px solid; background-color:#fffccc;" align="center" >
ET2<br />
<input type="checkbox" name="checkbox2" value="checkbox" onClick="todos_ept2(this);"> 
</td>
<td  class="ancho_td_no" style="border-bottom:1px solid; border-right:1px solid; background-color:#fffccc; " align="center" >
ET3<br />
<input type="checkbox" name="checkbox3" value="checkbox" onClick="todos_ept3(this);"> 
</td>
<td  class="ancho_td_no" style="border-bottom:1px solid; border-right:1px solid; background-color:#fffccc;" align="center" >
ET4<br />
<input type="checkbox" name="checkbox4" value="checkbox" onClick="todos_ept4(this);"> 
</td>
</tr>
<?php $i=1; do  { ?>
<tr >
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
		       <select class="texto_pequeno_gris"  name="<?php echo 'ept1'.$i; ?>" id="<?php echo 'ept1'.$i; ?>">
...
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
		       <select class="texto_pequeno_gris"  name="<?php echo 'ept2'.$i; ?>" id="<?php echo 'ept2'.$i; ?>">
            			<option value="0">..</option>
            			<option value="1">X</option>
             			<option value="2">-</option>
                	</select>
...
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
		       <select class="texto_pequeno_gris"  name="<?php echo 'ept3'.$i; ?>" id="<?php echo 'ept3'.$i; ?>">
            			<option value="0">..</option>
            			<option value="1">X</option>
             			<option value="2">-</option>
                	</select>
...
<td class="ancho_td_nota" style="border-right:1px solid; border-bottom:1px solid;" align="center" >
		       <select class="texto_pequeno_gris"  name="<?php echo 'ept4'.$i; ?>" id="<?php echo 'ept4'.$i; ?>">
            			<option value="0">..</option>
            			<option value="1">X</option>
             			<option value="2">-</option>
                	</select>
