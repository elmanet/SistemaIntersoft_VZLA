...
mysql_select_db($database_sistemacol, $sistemacol);
$query_planestudio = "SELECT a.id as curso_id, b.descripcion, c.nombre FROM jos_curso a, jos_seccion b, jos_anio_nombre c WHERE a.seccion_id=b.id AND a.anio_id=c.id AND c.orden_resumen>0 ORDER BY c.numero_anio, b.id ASC";
...
<tr><td>
<form action="cargar_resumen_pendiente2.php" name="form" id="form" method="POST" enctype="multipart/form-data" target="_blank">
<div id="recuadro_cedula"><br />
<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Materia Pendiente!</h2>
Selecciona A&ntilde;o y Secci&oacute;n<br />
<select name="curso_id" id="curso_id">
				<?php
				do { ?>
             			<option value="<?php echo $row_planestudio['curso_id']; ?>"><?php echo $row_planestudio['nombre']." - ".$row_planestudio['descripcion']; ?></option>
...
<td width="175" height="50">
Tipo de Identificaci&oacute;n<br />
