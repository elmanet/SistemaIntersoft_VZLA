...
?></td>
	...
	<?php  //sumatoria INSISTENCIAS
		if(($row_resumen['m1']==98) or ($row_resumen['m1']==99)) {$si1=0;}
		if(($row_resumen['m2']==98) or ($row_resumen['m2']==99)){$si2=0;}
		if(($row_resumen['m3']==98) or ($row_resumen['m3']==99)) {$si3=0;}
		if(($row_resumen['m4']==98) or ($row_resumen['m4']==99)){$si4=0;}
		if(($row_resumen['m5']==98) or ($row_resumen['m5']==99)){$si5=0;}
		if(($row_resumen['m6']==98) or ($row_resumen['m6']==99)){$si6=0;}
		if(($row_resumen['m7']==98) or ($row_resumen['m7']==99)){$si7=0;}
		if(($row_resumen['m8']==98) or ($row_resumen['m8']==99)){$si8=0;}
		if(($row_resumen['m9']==98) or ($row_resumen['m9']==99)){$si9=0;}
		if(($row_resumen['m10']==98) or ($row_resumen['m10']==99)){$si10=0;}
		if(($row_resumen['m11']==98) or ($row_resumen['m11']==99)){$si11=0;}
		if(($row_resumen['m12']==98) or ($row_resumen['m12']==99)){$si12=0;}
		if(($row_resumen['m13']==98) or ($row_resumen['m13']==99)){$si13=0;}
		if(($row_resumen['m14']==98) or ($row_resumen['m14']==99)){$si14=0;}
	...
	<?php  //sumatoria REPROBADAS
		if(($row_resumen['m1']>0) and ($row_resumen['m1']<10) or ($row_resumen['m1']==99)) {$sr1++;}
		if(($row_resumen['m2']>0) and ($row_resumen['m2']<10) or ($row_resumen['m2']==99)) {$sr2++;}
		if(($row_resumen['m3']>0) and ($row_resumen['m3']<10) or ($row_resumen['m3']==99)) {$sr3++;}
		if(($row_resumen['m4']>0) and ($row_resumen['m4']<10) or ($row_resumen['m4']==99)) {$sr4++;}
		if(($row_resumen['m5']>0) and ($row_resumen['m5']<10) or ($row_resumen['m5']==99)) {$sr5++;}
		if(($row_resumen['m6']>0) and ($row_resumen['m6']<10) or ($row_resumen['m6']==99)) {$sr6++;}
		if(($row_resumen['m7']>0) and ($row_resumen['m7']<10) or ($row_resumen['m7']==99)) {$sr7++;}
		if(($row_resumen['m8']>0) and ($row_resumen['m8']<10) or ($row_resumen['m8']==99)) {$sr8++;}
		if(($row_resumen['m9']>0) and ($row_resumen['m9']<10) or ($row_resumen['m9']==99)) {$sr9++;}
		if(($row_resumen['m10']>0) and ($row_resumen['m10']<10) or ($row_resumen['m10']==99)) {$sr10++;}
		if(($row_resumen['m11']>0) and ($row_resumen['m11']<10) or ($row_resumen['m11']==99)) {$sr11++;}
		if(($row_resumen['m12']>0) and ($row_resumen['m12']<10) or ($row_resumen['m12']==99)) {$sr12++;}
		if(($row_resumen['m13']>0) and ($row_resumen['m13']<10) or ($row_resumen['m13']==99)) {$sr13++;}
		if(($row_resumen['m14']>0) and ($row_resumen['m14']<10) or ($row_resumen['m14']==99)) {$sr14++;}
	...
	<?php $no++; } while($no <= $tr); }?>
		...
		<table><tr>
			...
			<td style="width:2cm; border-width: 0 0 1px 0; text-align:right;height: 0.4cm; ">INSC&nbsp;&nbsp;</td>
			</tr>
			<tr>
			<td style="width:2cm; border-width: 0 0 1px 0; text-align:right;height: 0.4cm;">INAS&nbsp;&nbsp;</td>
			</tr>
			<tr>
			<td style="width:2cm; border-width: 0 0 1px 0; text-align:right;height: 0.4cm;">APRO&nbsp;&nbsp;</td>
			</tr>
			<tr>
			<td style="width:2cm; border-width: 0 0 0 0; text-align:right;height: 0.4cm;">APLAZ&nbsp;&nbsp;</td>
			</tr>
		</table>
		</td>
