...
$query_asigna = sprintf("SELECT a.id, a.nombre as mate, a.iniciales, a.numero, a.nombre_docente, a.apellido_docente, b.nombre as anio FROM jos_cdc_resumen_asignatura_pendiente a, jos_anio_nombre b WHERE a.anio_id=b.id  ORDER BY a.numero ASC");
...
<table width="800" border="0">
  <tr>
       <td class="titulo_extragrande_gris" colspan="2">Listado de Asignaturas de Materia Pendiente</td>
      </tr>
      <tr><td>
	
	&nbsp;&nbsp;&nbsp;<a href="admin_asignatura_ept2.php"><img src="../../images/png/apply_f2.png" align="absmiddle" border="0" width="25"></a>&nbsp;<a href="admin_asignatura_ept2.php">Cargar Nueva Asignatura</a>
      </td></tr>
<tr><td>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#006600" bordercolor="#000000" bordercolordark="#000000" class="fondo_tabla" id="marco_tabla">
		...
		<td width="30" class="textogrande_eloy"  style="border-left:1px solid"><div align="center"><span class="texto_mediano_gris">&nbsp;Iniciales&nbsp;</span></div></td>
		...
		<td height="20" class="textoVARIOS_eloy"  style="border-left:1px solid"><div align="center"><span class="texto_mediano_gris"><?php echo $row_asigna['anio']; ?></span></div></td>
      ...
      <td height="20" class="textoVARIOS_eloy"  style="border-left:1px solid"><div align="center"><span class="texto_mediano_gris"><?php echo $row_asigna['anio']; ?></span></div></td>		
		<td height="20" class="textoVARIOS_eloy"  style="border-left:1px solid"><div align="center"><span class="texto_mediano_gris"><?php echo $row_asigna['numero']; ?></span></div></td>
