...
<tr><td>
<form action="modificar_resumen2.php" name="form" id="form" method="POST" enctype="multipart/form-data" target="_blank">
<div id="recuadro_cedula"><br />
<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Modificar Resumen!</h2>
