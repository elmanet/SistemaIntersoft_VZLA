...
<tr  bgcolor="#<?php if ($i%2==0) { // si es par
   ...
   <td align="center">	
	...
	<select name="<?php echo 'fecha_anio'.$i; $fec=2011;?>">
	<option value="">**</option>
	<?php $fec=date(Y);
	do { ?>
	<option value="<?php echo $fec;?>"><?php echo $fec;?></option>
...
mysql_free_result($alumno_plan1);
mysql_free_result($anio);
mysql_free_result($plantelcurso);
mysql_free_result($eptcurso);
mysql_free_result($observaciones);
mysql_free_result($plantel);
mysql_free_result($plantel_dos);
mysql_free_result($plantel_tres);
mysql_free_result($plantel_cuatro);
mysql_free_result($plantel_cinco);
mysql_free_result($local1);
mysql_free_result($local2);
mysql_free_result($local3);
mysql_free_result($local4);
mysql_free_result($local5);
mysql_free_result($ept1);
mysql_free_result($ept2);
mysql_free_result($ept3);
mysql_free_result($ept4);
mysql_free_result($ept5);
mysql_free_result($ept6);
mysql_free_result($ept7);
mysql_free_result($ept8);
mysql_free_result($ept9);
mysql_free_result($ept10);

mysql_free_result($alumno_plan2);
mysql_free_result($alumno_plan3);
mysql_free_result($alumno_plan4);
mysql_free_result($alumno_plan5);
mysql_free_result($alumno_plan6);
mysql_free_result($notas_plan1);
mysql_free_result($notas_plan2);
mysql_free_result($notas_plan3);
mysql_free_result($notas_plan4);
mysql_free_result($notas_plan5);
mysql_free_result($notas_plan6);
