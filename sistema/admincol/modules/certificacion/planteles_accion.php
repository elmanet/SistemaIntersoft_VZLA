...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  ...
  $insertSQL = sprintf("INSERT INTO jos_cdc_nombre_plantel (id, nombre_plantel) VALUES (%s, %s)",
...
<table width="850" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Cargar nuevo Plantel!</h2>
...
<form action="<?php echo $editFormAction; ?>" name="form" id="form" method="POST" enctype="multipart/form-data" onKeyPress="return disableEnterKey(event)">
	<tr >
		<td width="80%" align="center"><input name="nombre_plantel" type="text" id="nombre_plantel" value="" size="60" onKeyUp="this.value=this.value.toUpperCase()"/></td>
		<td width="20%" align="center"><input type="submit" name="buttom" value="Cargar >" />
...
<p align="center">"Escriba el nombre del Plantel como aparece en la Certificaci&oacute;n de Calificaciones" <br /></p>
</div>
</div>
	</td></tr>
