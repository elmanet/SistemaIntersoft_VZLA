...
mysql_select_db($database_sistemacol, $sistemacol);
$query_consulta = sprintf("SELECT * FROM jos_cdc_localidad WHERE id=%s", GetSQLValueString($colname_consulta, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "modi_form")) {
     ...
     $updateSQL = sprintf("update jos_cdc_localidad SET localidad=%s WHERE id=%s",
...
<table width="900" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Modificar Localidad!</h2>
...
<table style="font-size:10px; font-family:verdana;" width="80%" BORDER="1" BORDERCOLOR="#fffccc" CELLSPACING="0" >
	...
	<tr >
		<td align="center"><input name="localidad" type="text" id="localidad" value="<?php echo $row_consulta['localidad']; ?>" size="25"/></td>
