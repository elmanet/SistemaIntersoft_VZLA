...
mysql_select_db($database_sistemacol, $sistemacol);
$query_alumno_seccion = sprintf("SELECT * FROM jos_cdc_resumen_pendiente WHERE anio_id=%s  AND tipo_resumen=%s  AND tipo_cedula=%s AND  plan_id=%s AND momento=%s", GetSQLValueString($colname_alumno_seccion, "int"), GetSQLValueString($tr_alumno_seccion, "int"), GetSQLValueString($tc_alumno_seccion, "int"), GetSQLValueString($plan_alumno_seccion, "int"), GetSQLValueString($momento_alumno_seccion, "int"));
...
<td class="cuadrito">*</td> <!--  columna 15 -->
	...
	<tr>
		<td><?php echo $no;?></td>
		<td style="text-align:left;">&nbsp;&nbsp;<a href="../../../modules/acciones/datos_notas_resumen_pendiente.php?id=<?php echo $row_resumen['id'];?>" target="_blank" class="nyroModal"><?php echo $row_resumen['indicador_nacionalidad']."-".$row_resumen['cedula'];?></a></td>
...
<?php // ASIGNATURAS INSCRITAS ?>
		...
		<td class="cuadrito"><?php if(($totalRows_asignaturas==10) and ($sm14>0)){if($sm14<10){echo "0".$sm14;}else{echo $sm14;} }else{ if(($sm11>0) and ($sm11<10)){echo "0".$sm11;} if($sm11>9){echo $sm11; } if(($sm11==NULL)and($row_seccion['orden_resumen']>3)){echo "00";}else{ echo "*";}}?></td>
...
<?php // INASISTENCIAS ?>		
		...
		<td class="cuadrito"><?php if(($totalRows_asignaturas==10) and ($si14>0)){if($si14<10){echo "0".$si14;}else{echo $si14;} }else{ if(($si11>0) and ($si11<10)){echo "0".$si11;} if($si11>9){echo $si11; } if(($si11==NULL)and($sm11==0)and($row_seccion['orden_resumen']>3)){echo "00";}else {echo "*";} if(($si11==NULL)and($sm11>0)){echo "00"; }}?></td>
...
*/?>
	...
	<tr>
		...
		<td class="cuadrito"><?php if(($totalRows_asignaturas==8) and ($sa14>0)){if($sa14<10){echo "0".$sa14;}else{echo $sa14;} }else{ if(($sa11>0) and ($sa11<10)){echo "0".$sa11;} if($sa11>9){echo $sa11; } if(($sa11==NULL)and($sm11==0)and($row_seccion['orden_resumen']>3)){echo "00"; }else {echo"*";} if(($sa11==NULL)and($sm11>0)){echo "00"; }}?></td>
...
*/?>
	...
	<?php // REPROBADAS ?>		
		...
		<td class="cuadrito"><?php if(($totalRows_asignaturas==10) and ($sr14>0)){if($sr14<10){echo "0".$sr14;}else{echo $sr14;} }else{ if(($sr11>0) and ($sr11<10)){echo "0".$sr11;} if($sr11>9){echo $sr11; } if(($sr11==NULL)and($sm11==0)and($row_seccion['orden_resumen']>3)){echo "00"; }else{echo "*"; } if(($sr11==NULL)and($sm11>0)){echo "00"; }}?></td>
