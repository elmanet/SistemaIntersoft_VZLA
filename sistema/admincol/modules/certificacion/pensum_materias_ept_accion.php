...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  ...
  $insertSQL = sprintf("INSERT INTO jos_cdc_pensum_asignaturas_ept (id, nombre_asignatura_ept,  anio_id) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "pensum_materias_ept.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<table width="850" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Cargar nueva Asignatura de Educaci&oacute;n para el Trabajo!</h2>
...
<form action="<?php echo $editFormAction; ?>" name="form" id="form" method="POST" enctype="multipart/form-data" onKeyPress="return disableEnterKey(event)">
	<tr >
		<td align="center"><input name="nombre_asignatura_ept" type="text" id="nombre_asignatura_ept" value="" size="25" onKeyUp="this.value=this.value.toUpperCase()"/></td>
		<td align="center">
