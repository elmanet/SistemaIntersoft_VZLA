...
mysql_select_db($database_sistemacol, $sistemacol);
$query_mate = sprintf("SELECT b.id, b.nombre_anio, b.inicial, b.no_anio, b.creado, c.plan_estudio, c.cod FROM jos_cdc_pensum_anios b, jos_cdc_planestudio c WHERE b.planestudio_id=c.id ORDER BY b.creado DESC");
