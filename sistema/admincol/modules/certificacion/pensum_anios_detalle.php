...
mysql_select_db($database_sistemacol, $sistemacol);
$query_mate = sprintf("SELECT b.id, b.nombre_anio, b.inicial, b.no_anio, b.creado, c.plan_estudio, c.cod FROM jos_cdc_pensum_anios b, jos_cdc_planestudio c WHERE b.planestudio_id=c.id AND b.planestudio_id=%s ORDER BY b.no_anio ASC", GetSQLValueString($colname_mate, "int"));
...
<table width="850" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<h2><img src="../../images/png/apply_f2.png" border="0" align="absmiddle">&nbsp;&nbsp;Listado de A&ntilde;os - Pensum de Estudio!</h2>
...
<a href="pensum_anio_accion.php"><img src="../../images/icons/nuevo.png" border="0" align="absmiddle">&nbsp;Cargar Nuevo A&ntilde;o</a>
</div>

<form action="pensum_anios_detalle.php" name="form" id="form" method="GET" enctype="multipart/form-data" >
...
<table style="font-size:10px; font-family:verdana;" width="90%" BORDER="1" BORDERCOLOR="#fffccc" CELLSPACING="0" >
	<tr style="font-size:12px; font-family:verdana; background-color:#fffccc;">
		...
		<td align="center">Nombre del A&ntilde;o</td>
		<td align="center">Iniciles</td>
		<td align="center">No. del A&ntilde;o</td>
	...
	<tr >
		...
		<td align="center"><?php echo $row_mate['inicial']; ?></td>
		<td align="center"><?php echo $row_mate['no_anio']; ?></td>
		<td align="center"><?php echo $row_mate['plan_estudio']; ?></td>
		<td align="center"><?php echo $row_mate['creado']; ?></td>
		<td align="center"><!-- <a href="pensum_materias_modificacion.php?id=<?php echo $row_mate['id'];?>"><img src="../../images/icons/modificar.png" border="0" align="absmiddle"></a>&nbsp;<a href="accion_eliminar.php?mate_id=<?php echo $row_mate['id'];?>"><img src="../../images/png/cancel_f2.png" width="15" height="15" border="0" align="absmiddle"></a>--></td>
	</tr>
