...
mysql_select_db($database_sistemacol, $sistemacol);
$query_resumen = sprintf("SELECT b.cedula, b.indicador_nacionalidad, a.id, a.no_alumno, a.m1, a.m2, a.m3, a.m4, a.m5, a.m6, a.m7, a.m8, a.m9, a.m10, a.m11, a.m12, a.m13, a.m14, a.ept1, a.ept2, a.ept3, a.ept4, c.cod, c.plan_estudio, c.mencion FROM jos_cdc_resumen a, jos_alumno_info b, jos_cdc_planestudio c WHERE a.alumno_id=b.alumno_id AND a.plan_id=c.id AND b.cursando=1 AND a.no_alumno>=$hojaini AND a.no_alumno<=$hojafin AND curso_id=%s AND tipo_resumen=%s AND tipo_cedula=%s ORDER BY b.cedula ASC", GetSQLValueString($colname_resumen, "int"), GetSQLValueString($tr_resumen, "int"), GetSQLValueString($tc_resumen, "int"));
...
mysql_select_db($database_sistemacol, $sistemacol);
$query_alumno_seccion = sprintf("SELECT * FROM jos_cdc_resumen WHERE curso_id=%s AND tipo_resumen=%s", GetSQLValueString($colname_alumno_seccion, "int"), GetSQLValueString($tr_alumno_seccion, "int"));
...
<div id="titulo_mencion">
	...
	<div class="titulo1" style="width:1.8cm;">
...
<?php if($row_asignaturas['orden_asignatura']==14){ echo $row_asignaturas['iniciales'];} ?>
</td>
...
ET
<?php } else { // CONDICION REALIZADA POR LOS QUE IP ES NORMAL
?>
*
<?php } ?>
</td>
...
<?php }?> 
<?php if($row_resumen['m14']!=""){ ?>
<?php  $totalmates=14-$totalRows_asignaturas; ?>
<?php }else { ?>
<?php  $totalmates=13-$totalRows_asignaturas; ?>
<?php } ?>
<?php do { ?>
<td class="cuadrito">
*
...
<td class="cuadrito">*</td> <!--  columna 15 -->
	...
	<tr>
		<td><?php echo $no;?></td>
		<td style="text-align:left;">&nbsp;&nbsp;<a href="../../../modules/acciones/datos_notas_resumen.php?id=<?php echo $row_resumen['id'];?>" target="_blank" class="nyroModal"><?php echo $row_resumen['indicador_nacionalidad']."-".$row_resumen['cedula'];?></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="../../../modules/acciones/eliminar_datos_notas_resumen.php?id=<?php echo $row_resumen['id'];?>" target="_blank" class="nyroModal"><img src="../../../images/png/cancel_f2.png" alt="" height="13" style="vertical-align:middle;"></a></td>
		<td><?php if(($row_resumen['m1']>0) and ($row_resumen['m1']<10)){echo "0".$row_resumen['m1'];} if(($row_resumen['m1']>9)and($row_resumen['m1']<21)){echo $row_resumen['m1'];}  if($row_resumen['m1']==99){echo "P";} if($row_resumen['m1']==98){echo "I";} if($row_resumen['m1']==NULL){echo "*";} ?></td>

		<td><?php if(($row_resumen['m2']>0) and ($row_resumen['m2']<10)){echo "0".$row_resumen['m2'];} if(($row_resumen['m2']>9)and($row_resumen['m2']<21)){echo $row_resumen['m2'];}  if($row_resumen['m2']==99){echo "P";} if($row_resumen['m2']==98){echo "I";} if($row_resumen['m2']==NULL){echo "*";} ?></td>

		<td><?php if(($row_resumen['m3']>0) and ($row_resumen['m3']<10)){echo "0".$row_resumen['m3'];} if(($row_resumen['m3']>9)and($row_resumen['m3']<21)){echo $row_resumen['m3'];}  if($row_resumen['m3']==99){echo "P";} if($row_resumen['m3']==98){echo "I";} if($row_resumen['m3']==NULL){echo "*";} ?></td>

		<td><?php if(($row_resumen['m4']>0) and ($row_resumen['m4']<10)){echo "0".$row_resumen['m4'];} if(($row_resumen['m4']>9)and($row_resumen['m4']<21)){echo $row_resumen['m4'];}  if($row_resumen['m4']==99){echo "P";} if($row_resumen['m4']==98){echo "I";} if($row_resumen['m4']==NULL){echo "*";} ?></td>

		<td><?php if(($row_resumen['m5']>0) and ($row_resumen['m5']<10)){echo "0".$row_resumen['m5'];} if(($row_resumen['m5']>9)and($row_resumen['m5']<21)){echo $row_resumen['m5'];}  if($row_resumen['m5']==99){echo "P";} if($row_resumen['m5']==98){echo "I";} if($row_resumen['m5']==NULL){echo "*";} ?></td>

		<td><?php if(($row_resumen['m6']>0) and ($row_resumen['m6']<10)){echo "0".$row_resumen['m6'];} if(($row_resumen['m6']>9)and($row_resumen['m6']<21)){echo $row_resumen['m6'];}  if($row_resumen['m6']==99){echo "P";} if($row_resumen['m6']==98){echo "I";} if($row_resumen['m6']==NULL){echo "*";} ?></td>

		<td><?php if(($row_resumen['m7']>0) and ($row_resumen['m7']<10)){echo "0".$row_resumen['m7'];} if(($row_resumen['m7']>9)and($row_resumen['m7']<21)){echo $row_resumen['m7'];}  if($row_resumen['m7']==99){echo "P";} if($row_resumen['m7']==98){echo "I";} if($row_resumen['m7']==NULL){echo "*";} ?></td>

		<td><?php if(($row_resumen['m8']>0) and ($row_resumen['m8']<10)){echo "0".$row_resumen['m8'];} if(($row_resumen['m8']>9)and($row_resumen['m8']<21)){echo $row_resumen['m8'];}  if($row_resumen['m8']==99){echo "P";} if($row_resumen['m8']==98){echo "I";} if($row_resumen['m8']==NULL){echo "*";} ?></td>

		<td><?php if(($row_resumen['m9']>0) and ($row_resumen['m9']<10)){echo "0".$row_resumen['m9'];} if(($row_resumen['m9']>9)and($row_resumen['m9']<21)){echo $row_resumen['m9'];}  if($row_resumen['m9']==99){echo "P";} if($row_resumen['m9']==98){echo "I";} if($row_resumen['m9']==NULL){echo "*";} ?></td>



		<td><?php if(($row_resumen['m9']!="") and ($row_resumen['m10']==NULL) and ($row_resumen['m14']!="")){ if(($row_resumen['m14']>0) and ($row_resumen['m14']<10)){echo "0".$row_resumen['m14'];} if(($row_resumen['m14']>9)and($row_resumen['m14']<21)){echo $row_resumen['m14'];}  if($row_resumen['m14']==90){echo "*";} if($row_resumen['m14']==99){echo "P";} if($row_resumen['m14']==98){echo "I";} if($row_resumen['m14']==NULL){echo "*";}}  

if($row_resumen['m10']!=""){ if(($row_resumen['m10']>0) and ($row_resumen['m10']<10)){echo "0".$row_resumen['m10'];} if(($row_resumen['m10']>9)and($row_resumen['m10']<21)){echo $row_resumen['m10'];}  if($row_resumen['m10']==99){echo "P";} if($row_resumen['m10']==98){echo "I";} if($row_resumen['m10']==NULL){echo "*";} } 
...
if($row_resumen['m11']!=""){ if(($row_resumen['m11']>0) and ($row_resumen['m11']<10)){echo "0".$row_resumen['m11'];} if(($row_resumen['m11']>9)and($row_resumen['m11']<21)){echo $row_resumen['m11'];}  if($row_resumen['m11']==99){echo "P";} if($row_resumen['m11']==98){echo "I";} if($row_resumen['m11']==NULL){echo "*";} } 
...
if($row_resumen['m12']!=""){ if(($row_resumen['m12']>0) and ($row_resumen['m12']<10)){echo "0".$row_resumen['m12'];} if(($row_resumen['m12']>9)and($row_resumen['m12']<21)){echo $row_resumen['m12'];}  if($row_resumen['m12']==99){echo "P";} if($row_resumen['m12']==98){echo "I";} if($row_resumen['m12']==NULL){echo "*";} } 
...
if($row_resumen['m13']!=""){ if(($row_resumen['m13']>0) and ($row_resumen['m13']<10)){echo "0".$row_resumen['m13'];} if(($row_resumen['m13']>9)and($row_resumen['m13']<21)){echo $row_resumen['m13'];}  if($row_resumen['m13']==99){echo "P";} if($row_resumen['m13']==98){echo "I";} if($row_resumen['m13']==NULL){echo "*";} } 
...
?></td>
		...
		<td>*</td>
		<td>*</td> <!-- columna 15 -->
		<td><?php if($row_resumen['ept1']==0){echo "*";} if($row_resumen['ept1']==1){echo "x";} if($row_resumen['ept1']==2){echo "<b>-</b>";}?></td>
		<td><?php if($row_resumen['ept2']==0){echo "*";} if($row_resumen['ept2']==1){echo "x";} if($row_resumen['ept2']==2){echo "<b>-</b>";}?></td>
		<td><?php if($row_resumen['ept3']==0){echo "*";} if($row_resumen['ept3']==1){echo "x";} if($row_resumen['ept3']==2){echo "<b>-</b>";}?></td>
		<td><?php if($row_resumen['ept4']==0){echo "*";} if($row_resumen['ept4']==1){echo "x";} if($row_resumen['ept4']==2){echo "<b>-</b>";}?></td>
		...
		if(($row_resumen['m1']==99) or ($row_resumen['m1']==98)or ($row_resumen['m2']==98)or ($row_resumen['m3']==98)or ($row_resumen['m4']==98)or ($row_resumen['m5']==98)or ($row_resumen['m6']==98)or ($row_resumen['m7']==98)or ($row_resumen['m8']==98)or ($row_resumen['m9']==98)or ($row_resumen['m10']==98)or ($row_resumen['m11']==98)or ($row_resumen['m12']==98)or ($row_resumen['m13']==98)or ($row_resumen['m14']==98)){echo "4"; }else{
...
<?php // ASIGNATURAS INSCRITAS ?>
		...
		<td class="cuadrito"><?php if(($totalRows_asignaturas==10) and ($sm14>0)){if($sm14<10){echo "0".$sm14;}else{echo $sm14;} }else{ if(($sm11>0) and ($sm11<10)){echo "0".$sm11;} if($sm11>9){echo $sm11; } if(($sm11==NULL)and($row_seccion['orden_resumen']==4)){echo "00";}else{ echo "*";}}?></td>
...
<?php // INASISTENCIAS ?>		
		...
		<td class="cuadrito"><?php if(($totalRows_asignaturas==10) and ($si14>0)){if($si14<10){echo "0".$si14;}else{echo $si14;} }else{ if(($si11>0) and ($si11<10)){echo "0".$si11;} if($si11>9){echo $si11; } if(($si11==NULL)and($sm11==0)and($row_seccion['orden_resumen']==4)){echo "00";}else {echo "*";} if(($si11==NULL)and($sm11>0)){echo "00"; }}?></td>
...
*/?>
	...
	<tr>
		...
		<td class="cuadrito"><?php if(($totalRows_asignaturas==8) and ($sa14>0)){if($sa14<10){echo "0".$sa14;}else{echo $sa14;} }else{ if(($sa11>0) and ($sa11<10)){echo "0".$sa11;} if($sa11>9){echo $sa11; } if(($sa11==NULL)and($sm11==0)and($row_seccion['orden_resumen']==4)){echo "00"; }else {echo"*";} if(($sa11==NULL)and($sm11>0)){echo "00"; }}?></td>
...
*/?>
	...
	<?php // REPROBADAS ?>		
		...
		<td class="cuadrito"><?php if(($totalRows_asignaturas==10) and ($sr14>0)){if($sr14<10){echo "0".$sr14;}else{echo $sr14;} }else{ if(($sr11>0) and ($sr11<10)){echo "0".$sr11;} if($sr11>9){echo $sr11; } if(($sr11==NULL)and($sm11==0)and($row_seccion['orden_resumen']==4)){echo "00"; }else{echo "*"; } if(($sr11==NULL)and($sm11>0)){echo "00"; }}?></td>
...
*/?>
	...
	<?php $no++; } while($no <= $tr);} ?>
		...
		<tr>
			<td style="height:0.4cm;border-width: 0 0 0px 0px;" ><?php if($totalRows_alumno_seccion<10){echo "0".$totalRows_alumno_seccion;}else{ echo $totalRows_alumno_seccion;} ?></td>
		</tr>
	</table>
	</tr>
