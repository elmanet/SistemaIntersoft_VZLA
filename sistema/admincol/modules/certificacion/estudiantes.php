...
mysql_select_db($database_sistemacol, $sistemacol);
$query_alumno = sprintf("SELECT * FROM jos_cdc_estudiante  ORDER BY apellido_alumno DESC");
$query_limit_alumno = sprintf("%s LIMIT %d, %d", $query_alumno, $startRow_alumno, $maxRows_alumno);
$alumno = mysql_query($query_limit_alumno, $sistemacol) or die(mysql_error());
