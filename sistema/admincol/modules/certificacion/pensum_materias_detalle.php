...
mysql_select_db($database_sistemacol, $sistemacol);
$query_mate = sprintf("SELECT a.id, a.nombre_asignatura, c.cod, a.orden_asignatura, b.nombre_anio, a.creado  FROM jos_cdc_pensum_asignaturas a, jos_cdc_pensum_anios b, jos_cdc_planestudio c WHERE a.anio_id=b.id AND b.planestudio_id=c.id AND b.planestudio_id=%s ORDER BY b.no_anio, a.orden_asignatura ASC", GetSQLValueString($colname_mate, "int"));
