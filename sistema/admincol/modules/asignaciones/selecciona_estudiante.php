...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<form action="asignar_estudiante_anomina.php" method="GET" name="f1" />
	  ...
	  $row_docente = mysql_fetch_assoc($docente);
	   ...
	   ?>
                    ...
                    <b class="texto_mediano_gris">C&eacute;dula:</b> <input type="text" size="15" name="cedula" id="cedula"/>
...
<p align="center">"Selecciona la Asignatura, a&ntilde;o, secci&oacute;n, lapso <br /> y N&uacute;mero de C&eacute;dula del Estudiante." <br /><br /><b>Nota:</b> Este m&oacute;dulo se utiliza cuando no &eacute;xite el estudiante en la n&oacute;mina de Calificaciones de alguna asignatura. </p>
</div>
</div>
	</td></tr>
	</form>
